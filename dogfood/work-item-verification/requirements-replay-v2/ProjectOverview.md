...
- Summary: WorkItemVerification requirements are defined from the approved V1 verification barrier: verify one exact execution result, keep evidence producers untrusted, require complete subject-bound evidence, and leave integration downstream.

...
const a2aSnapshot = {
  source: {
    ...
    uri: "fixture://devrelay/a2a/lifecycle-run-report-documentation-specialist-card.json",
  },
  agentCard,
  toolIds: [],
  grantIds: [],
...
const documentationWorkItem = workBreakdown.workItems.find(({ id }) => id === "WI-RUN-DOCUMENTATION");
const assignmentPolicy = {
  apiVersion: "devrelay.dev/v1alpha1",
  kind: "AssignmentPolicy",
  policyId: "AP-RUN-DOGFOOD-001",
  version: "1.0.0",
  workItemRules: [],
  profilePriorities: [

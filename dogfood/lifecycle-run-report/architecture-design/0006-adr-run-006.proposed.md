# Apply deterministic content policy before rendering
...
- OPT-RUN-POLICY-BEFORE-RENDER
- OPT-RUN-POST-HOC-REDACTION

## Decision outcome

Chosen: OPT-RUN-POLICY-BEFORE-RENDER. The selected boundary preserves canonical DevRelay authority while making operational evidence inspectable and comparable.

...
const APPROVED = Object.freeze({
  candidate: "sha256:f35f88df082c9969787ee03bc057003163747be83fe2188c4b739dcda5552aa5",
  gateReview: "sha256:584dac944262698ee32642346c8a40a223525e448da950ea903df9e0034889dc",
  gateCandidate: "sha256:1eb10d10d550a87f0a9e232b649fe31d3a7fbbe108ea10a0ef6bb57e60ac99d0",
  checkpoint: "sha256:2866c01fa48419dddb49795c2377dda57ad03487591db99e69e41d6a0eb274f4",
  checkpointRaw: "sha256:034cce616ca1dfa2bd09c1b1b6665eca5dead40d76c4e90893682531f9b3f221",
  ...
  repositoryTree: "sha256:6d27786016084029b7148e33d7200656366120cd986f046d32b9e406c12b33dd",
});
...
const candidate = await loadedJson(
  "dogfood/architecture-discovery/dependency-analysis/work-dependency-candidate.json",
  {
  ...
  "WDC-F7AA1EABFEADB313",
);
const gateReview = await loadedJson(
  "dogfood/architecture-discovery/dependency-analysis/work-dependency-gate-review.json",
  CONTRACTS.gateReview,
  "WDA-AD-GATE-REVIEW-001",
);
const gateCandidate = await loadedJson(
  "dogfood/architecture-discovery/dependency-analysis/gate-candidate.json",
  CONTRACTS.gateCandidate,
  "WDA-AD-GATE-CANDIDATE-001",
);
const checkpoint = await loadedJson(
  "dogfood/architecture-discovery/dependency-analysis/execution-checkpoint.json",
  CONTRACTS.executionCheckpoint,
  "WDA-AD-DOGFOOD-001-CHECKPOINT",
);
...
const approvalValue = {
  ...
  approvalId: "WDA-AD-GATE-OWNER-APPROVAL-001",
...
const priorRecord = await loadedJson(
  ...
  "work-breakdown-decompose-architecture-discovery-v1",
);
...
const invocation = {
  ...
  invocationId: "work-dependency-gate-promote-architecture-discovery-v1",
  runId: "work-dependency-gate-run-architecture-discovery-v1",
  nodeId: "work-dependency-gate-node-architecture-discovery-v1",
  module,
  inputs: {},
  options: {},
};
...
const promotionProofValue = {
  ...
  proofId: "WDA-AD-GATE-PROMOTION-001",
  status: "promoted",
  approval: approval.ref,
  gateCandidate: gateCandidate.ref,
...
const baselineHistory = new URL("project/history/work-dependency/WDB-CI-DOGFOOD/", ROOT);

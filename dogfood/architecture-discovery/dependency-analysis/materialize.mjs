...
const workBreakdown = await loadedFile(
  "dogfood/architecture-discovery/work-breakdown/work-breakdown-baseline.json",
...
const contextSliceSetValue = {
  ...
  sliceSetId: "CTXS-AD-DOGFOOD-001",
  slices: [
    createContextSlice({
      id: "CTX-AD-REQUIREMENTS",
...
const execution = await runtime.execute({
  executionId: "WDA-AD-DOGFOOD-001",
  workBreakdown,
  projectOverview,
  contextSliceSet,
  policyBundle,
...
const gateReview = await exactJsonFile(
  "work-dependency-gate-review.json",
  {
    ...
    reviewId: "WDA-AD-GATE-REVIEW-001",
...
const gateCandidate = await exactJsonFile(
  "gate-candidate.json",
  {
    ...
    gateCandidateId: "WDA-AD-GATE-CANDIDATE-001",
    candidate: execution.candidateRef,
    workBreakdownBaseline: workBreakdown.ref,

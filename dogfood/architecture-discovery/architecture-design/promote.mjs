...
export async function promoteArchitectureDiscoveryArchitecture(context) {
  const {
    root,
    dir,
    read,
  ...
  const ownerApprovalBytes = read(
    "dogfood/architecture-discovery/architecture-design/architecture-gate-owner-approval.json",
  );
  ...
  const gateReviewRef = fileRef(
    "architecture-gate-review-architecture-discovery-v1",
  ...
  const executionProofRef = fileRef(
    "architecture-dogfood-execution-proof-architecture-discovery-v1",
  ...
  const promotedBaseline = {
    ...
    baselineId: "architecture-baseline-devrelay-v1-architecture-discovery-001",
  ...
  const promotedProjectState = {
    ...
    stateId: "project-architecture-state-devrelay-architecture-discovery-approved-v1",
    state: "baselined",
  ...
  const expectedRequiredInterfaces = [
    ...
    "IF-CI-ADAPTER-INVOCATION",
    "IF-CI-CHECKPOINT-RECOVERY",
    "IF-CI-INPUT-BINDING",
    "IF-CI-INTEGRATION-PLAN",
    "IF-CI-RESULT-VALIDATION",
    "IF-CI-TARGET-CAS",
    "IF-CI-TRACEABILITY",
  ...
  const promotionId = "architecture-promotion-architecture-discovery-v1";
  ...
  fs.writeFileSync(
    path.join(projectDir, "architecture-gate-owner-approval-architecture-discovery-v1.json"),
    ownerApprovalBytes,
  );

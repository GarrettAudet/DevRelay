...
const a2aSnapshot = {
  source: {
    ...
    uri: "fixture://devrelay/a2a/architecture-discovery-documentation-specialist-card.json",
  },
  agentCard,
  toolIds: [],
  grantIds: [],
...
const documentationWorkItem = workBreakdown.workItems.find(({ id }) => id === "WI-AD-DOCUMENTATION");
const assignmentPolicy = {
  apiVersion: "devrelay.dev/v1alpha1",
  kind: "AssignmentPolicy",
  policyId: "AP-AD-DOGFOOD-001",
  version: "1.0.0",
  workItemRules: [],
  profilePriorities: [

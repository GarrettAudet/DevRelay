...
const projectOverview = read("../../../project/history/1.7.0/project-overview-baseline.json");
...
const a2aSnapshot = {
  source: {
    ...
    uri: "fixture://devrelay/a2a/work-execution-documentation-specialist-card.json",
  },
  agentCard,
  toolIds: [],
  grantIds: [],
...
const documentationWorkItem = workBreakdown.workItems.find(({ id }) => id === "WI-WE-DOCUMENTATION");
const assignmentPolicy = {
  apiVersion: "devrelay.dev/v1alpha1",
  kind: "AssignmentPolicy",
  policyId: "AP-WE-DOGFOOD-001",
  version: "1.0.0",
  workItemRules: [],
  profilePriorities: [

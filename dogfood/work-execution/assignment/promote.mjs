...
writeExact("./replay-v6/candidate-traceability-update.json",
  candidate.prepared.update,
);
writeExact("./replay-v6/candidate-traceability-merge-receipt.json",
  candidate.merged.receipt,
);
writeExact("./replay-v6/approved-traceability-update.json", approved.prepared.update);
writeExact("./replay-v6/approved-traceability-merge-receipt.json",
  approved.merged.receipt,
);
writeExact("./replay-v6/traceability-graph-snapshot.json", approved.merged.snapshot);

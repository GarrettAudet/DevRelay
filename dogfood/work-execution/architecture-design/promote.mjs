...
export async function promoteWorkExecutionArchitecture(context) {
  const {
    root,
    dir,
    read,
  ...
  const ownerApprovalBytes = read(
    "dogfood/work-execution/architecture-design/architecture-gate-owner-approval.json",
  );
  ...
  const gateReviewRef = fileRef(
    "architecture-gate-review-work-execution-v1",
  ...
  const executionProofRef = fileRef(
    "architecture-dogfood-execution-proof-work-execution-v1",
  ...
  const promotedBaseline = {
    ...
    baselineId: "architecture-baseline-devrelay-v1-work-execution-001",
  ...
  const promotedProjectState = {
    ...
    stateId: "project-architecture-state-devrelay-work-execution-approved-v1",
    state: "baselined",
  ...
  const promotionId = "architecture-promotion-work-execution-v1";
  ...
  fs.writeFileSync(
    path.join(projectDir, "architecture-gate-owner-approval-work-execution-v1.json"),
    ownerApprovalBytes,
  );

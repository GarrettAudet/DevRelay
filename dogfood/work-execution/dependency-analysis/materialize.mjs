...
const contextSliceSetValue = {
  ...
  sliceSetId: "CTXS-WE-DOGFOOD-001",
  slices: [
    createContextSlice({
      id: "CTX-WE-REQUIREMENTS",
...
const execution = await runtime.execute({
  executionId: "WDA-WE-DOGFOOD-001",
  workBreakdown,
  projectOverview,
  contextSliceSet,
  policyBundle,
...
const gateReview = await exactJsonFile(
  "work-dependency-gate-review.json",
  {
    ...
    reviewId: "WDA-WE-GATE-REVIEW-001",
...
const gateCandidate = await exactJsonFile(
  "gate-candidate.json",
  {
    ...
    gateCandidateId: "WDA-WE-GATE-CANDIDATE-001",
    candidate: execution.candidateRef,
    workBreakdownBaseline: workBreakdown.ref,

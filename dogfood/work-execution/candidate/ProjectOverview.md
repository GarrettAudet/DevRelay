...
- Summary: WorkExecution requirements are clarified: one ready work item per isolated immutable attempt, Core-validated runtime binding, proposed changes plus raw evidence only, and linked non-overwriting retries.

...
const a2aSnapshot = {
  source: {
    ...
    uri: "fixture://devrelay/a2a/change-integration-documentation-specialist-card.json",
  },
  agentCard,
  toolIds: [],
  grantIds: [],
...
const documentationWorkItem = workBreakdown.workItems.find(({ id }) => id === "WI-CI-DOCUMENTATION");
const assignmentPolicy = {
  apiVersion: "devrelay.dev/v1alpha1",
  kind: "AssignmentPolicy",
  policyId: "AP-CI-DOGFOOD-001",
  version: "1.0.0",
  workItemRules: [],
  profilePriorities: [

...
const historicalUpdateSourcePaths = [
  ...
  "../../work-execution/work-breakdown/traceability-update.json",
  "../../work-item-verification/work-breakdown/traceability-update.json",
...
const draft = loaded(
  ...
  draftValue.draftId,
  "file:///dogfood/change-integration/assignment/specialist-assignment-draft.json",
);
const candidate = await merge({
  invocation: {
    invocationId: "SA-CI-DOGFOOD-001",
    module: {
...
const approved = await merge({
  invocation: {
    invocationId: "SA-CI-GATE-DOGFOOD-001",
    module: {

...
const workBreakdown = await loadedFile(
  "dogfood/change-integration/work-breakdown/work-breakdown-baseline.json",
...
const contextSliceSetValue = {
  ...
  sliceSetId: "CTXS-CI-DOGFOOD-001",
  slices: [
    createContextSlice({
      id: "CTX-CI-REQUIREMENTS",
...
const execution = await runtime.execute({
  executionId: "WDA-CI-DOGFOOD-001",
  workBreakdown,
  projectOverview,
  contextSliceSet,
  policyBundle,
...
const gateReview = await exactJsonFile(
  "work-dependency-gate-review.json",
  {
    ...
    reviewId: "WDA-CI-GATE-REVIEW-001",
...
const gateCandidate = await exactJsonFile(
  "gate-candidate.json",
  {
    ...
    gateCandidateId: "WDA-CI-GATE-CANDIDATE-001",
    candidate: execution.candidateRef,
    workBreakdownBaseline: workBreakdown.ref,

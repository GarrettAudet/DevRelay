...
const APPROVED = Object.freeze({
  candidate:
    "sha256:716603346910201f05b7b6e1d01ee7a29127f59964ea15e206c7b06de9c529a5",
  gateReview:
    "sha256:c9302c54cedda6cc33aacedcdf873ffd516f41ceab079c36cea7099701d7d805",
  gateCandidate:
    "sha256:21015910d891c245bec57a1a5dfd17e58b917851628609a5a02a4057a521bc37",
  checkpoint:
    "sha256:328b0a771b2e09771fa5c9565a4fa4409e5807f9133e702892d973f490b51619",
  checkpointRaw:
    "sha256:45ddd70eb03eb52e4ab046620d9d39a92cc498dd83b830f24d1f873ae5a9d25a",
  repositorySnapshot:
...
const candidate = await loadedJson(
  "dogfood/change-integration/dependency-analysis/work-dependency-candidate.json",
  {
  ...
  "WDC-171FF581461C108E",
);
const gateReview = await loadedJson(
  "dogfood/change-integration/dependency-analysis/work-dependency-gate-review.json",
  CONTRACTS.gateReview,
  "WDA-CI-GATE-REVIEW-001",
);
const gateCandidate = await loadedJson(
  "dogfood/change-integration/dependency-analysis/gate-candidate.json",
  CONTRACTS.gateCandidate,
  "WDA-CI-GATE-CANDIDATE-001",
);
const checkpoint = await loadedJson(
  "dogfood/change-integration/dependency-analysis/execution-checkpoint.json",
  CONTRACTS.executionCheckpoint,
  "WDA-CI-DOGFOOD-001-CHECKPOINT",
);
...
const approvalValue = {
  ...
  approvalId: "WDA-CI-GATE-OWNER-APPROVAL-001",
...
const priorRecord = await loadedJson(
  ...
  "work-breakdown-decompose-change-integration-v1",
);
...
const invocation = {
  ...
  invocationId: "work-dependency-gate-promote-change-integration-v1",
  runId: "work-dependency-gate-run-change-integration-v1",
  nodeId: "work-dependency-gate-node-change-integration-v1",
  module,
  inputs: {},
  options: {},
};
...
const promotionProofValue = {
  ...
  proofId: "WDA-CI-GATE-PROMOTION-002",
  status: "promoted",
  approval: approval.ref,
  gateCandidate: gateCandidate.ref,
...
const baselineHistory = new URL("project/history/work-dependency/WDB-WIV-DOGFOOD/", ROOT);

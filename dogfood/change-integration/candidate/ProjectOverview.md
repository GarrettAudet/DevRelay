...
- Summary: ChangeIntegration requirements are approved: integrate one verified work item into one configured local Git ref with Core-owned compare-and-swap, explicit no-mutation conflicts, immutable effect evidence, and SystemVerification downstream.

...
export async function promoteChangeIntegrationArchitecture(context) {
  const {
    root,
    dir,
    read,
  ...
  const ownerApprovalBytes = read(
    "dogfood/change-integration/architecture-design/architecture-gate-owner-approval.json",
  );
  ...
  const gateReviewRef = fileRef(
    "architecture-gate-review-change-integration-v1",
  ...
  const executionProofRef = fileRef(
    "architecture-dogfood-execution-proof-change-integration-v1",
  ...
  const promotedBaseline = {
    ...
    baselineId: "architecture-baseline-devrelay-v1-change-integration-001",
  ...
  const promotedProjectState = {
    ...
    stateId: "project-architecture-state-devrelay-change-integration-approved-v1",
    state: "baselined",
  ...
  const promotionId = "architecture-promotion-change-integration-v1";
  ...
  fs.writeFileSync(
    path.join(projectDir, "architecture-gate-owner-approval-change-integration-v1.json"),
    ownerApprovalBytes,
  );

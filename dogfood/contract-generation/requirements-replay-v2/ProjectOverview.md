...
- Lifecycle: existing
- Phase: planning
- Summary: ContractGeneration requirements are clarified: separate state-routed operations, untrusted generators, Core-owned pinned format validation and canonical diff, ContractGate authority, a live JSON Schema 2020-12 path first, typed draft/change-set outputs, and separate candidate/approved traceability projections.

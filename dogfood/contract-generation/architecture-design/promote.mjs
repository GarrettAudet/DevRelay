...
export async function promoteContractGenerationArchitecture(context) {
  const {
    root,
    dir,
    read,
  ...
  const ownerApprovalBytes = read(
    "dogfood/contract-generation/architecture-design/architecture-gate-owner-approval.json",
  );
  ...
  const gateReviewRef = fileRef(
    "architecture-gate-review-contract-generation-v1",
  ...
  const executionProofRef = fileRef(
    "architecture-dogfood-execution-proof-contract-generation-v1",
  ...
  const promotedBaseline = {
    ...
    baselineId: "architecture-baseline-devrelay-v1-contract-generation-001",
  ...
  const promotedProjectState = {
    ...
    stateId: "project-architecture-state-devrelay-contract-generation-approved-v1",
    state: "baselined",
  ...
  const promotionId = "architecture-promotion-contract-generation-v1";
  ...
  fs.writeFileSync(
    path.join(replayDir, "architecture-gate-owner-approval-contract-generation-v1.json"),
    ownerApprovalBytes,
  );

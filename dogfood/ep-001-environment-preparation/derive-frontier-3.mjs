...
const firstFacts = [
  readJson("dogfood/ep-001-environment-preparation/frontier-2/COMPLETION-WI-EP-ARTIFACT-CONTRACTS-001.json"),
];
const execution = readJson("dogfood/ep-001-environment-preparation/execution-frontier-2/execution-summary.json");
const verification = readJson("dogfood/ep-001-environment-preparation/verification-frontier-2/verification-summary.json");
const integration = readJson("dogfood/ep-001-environment-preparation/integration-frontier-2/integration-summary.json");
const integratedRefs = new Map([
  ["WI-EP-PROFILE-INVENTORY", integration.results[0].integratedChange],
]);
...
const readyFrontier = deriveReadyFrontier({ baseline, completionFacts, frontierId: "FRONTIER-EP-001-003" });

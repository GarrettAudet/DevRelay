...
const REPOSITORY_REVISION = "eb56676de9771a16c6800b11ed9c4762cc8cd83c";
...
const contextSliceSetValue = {
  ...
  sliceSetId: "CTXS-WDA-EP-001-001",
  slices: [
    createContextSlice({
      id: "CTX-WDA-EP-001-REQUIREMENTS",
    ...
    createContextSlice({
      id: "CTX-WDA-EP-001-ARCHITECTURE",
    ...
    createContextSlice({
      id: "CTX-WDA-EP-001-REPOSITORY-REVISION",
...
const gateReview = await exactJsonFile(
  "work-dependency-gate-review.json",
  {
    ...
    reviewId: "WDA-GATE-REVIEW-EP-001-001",
...
const gateCandidate = await exactJsonFile(
  "gate-candidate.json",
  {
    ...
    gateCandidateId: "WDA-GATE-CANDIDATE-EP-001-001",
    candidate: execution.candidateRef,
    workBreakdownBaseline: workBreakdown.ref,

...
const APPROVED = Object.freeze({
  candidate: "sha256:4f735f40219e64c5dd170e8832bb728d359ead58e7d75600093a48c2909afdb0",
  gateReview: "sha256:3883c3c5df100970d3d553ccd7bc7b709876875e8e05b1eb378ab7d4453d1bd2",
  gateCandidate: "sha256:c47392217268f3c62199e86de30d2841151e2e8bcc1f261b1bc6ce27a110c5cc",
  checkpoint: "sha256:e7bd4a08d264c63ae7de0701fded8525848b39e8b2aa3ae5b8ddd3c7f051fda6",
  checkpointRaw: "sha256:4d7a4f0c328619cba1f242c5dc0166c05f1780cd7e06b73960679db913c97932",
  repositorySnapshot: "sha256:ad1ed074d918f94d371c7b980054d3ba92b743d7d36b051b657d65af3a23f65b",
  repositoryRevision: "eb56676de9771a16c6800b11ed9c4762cc8cd83c",
  repositoryTree: "sha256:b101b0404cc55b21bc275cc6edbe1110ee7dd8a36c52652be4aae24c7063cc28",
});
...
const repositorySnapshot = await loadedJson(
  ...
  "repository-snapshot-devrelay-a18e6fb",
);
...
const candidate = await loadedJson(
  ...
  "WDC-A9BE10A0C945E484",
);
const gateReview = await loadedJson(
  "dogfood/ep-001-environment-preparation/dependency-analysis/work-dependency-gate-review.json",
  CONTRACTS.gateReview,
  "WDA-GATE-REVIEW-EP-001-001",
);
const gateCandidate = await loadedJson(
  "dogfood/ep-001-environment-preparation/dependency-analysis/gate-candidate.json",
  CONTRACTS.gateCandidate,
  "WDA-GATE-CANDIDATE-EP-001-001",
);
const checkpoint = await loadedJson(
  "dogfood/ep-001-environment-preparation/dependency-analysis/execution-checkpoint.json",
  CONTRACTS.executionCheckpoint,
  "WDA-EP-001-001-CHECKPOINT",
);
...
const approvalValue = {
  ...
  approvalId: "WDA-GATE-OWNER-APPROVAL-EP-001-001",
...
const priorRecord = await loadedJson(
  "dogfood/ep-001-environment-preparation/work-breakdown/module-execution-record.json",
  CONTRACTS.executionRecord,
  "work-breakdown-decompose-ep-001-v1",
);
const priorGraphUrl = new URL(
  "dogfood/ep-001-environment-preparation/work-breakdown/traceability-graph-snapshot.json",
  ROOT,
);
...
const invocation = {
  ...
  invocationId: "work-dependency-gate-promote-ep-001-v1",
  runId: "work-dependency-gate-run-ep-001-v1",
  nodeId: "work-dependency-gate-node-ep-001-v1",
  module,
  inputs: {},
  options: {},
};
...
const promotionProofValue = {
  ...
  proofId: "WDA-GATE-PROMOTION-EP-001-001",
  status: "promoted",
  approval: approval.ref,
  gateCandidate: gateCandidate.ref,
...
const baselineHistory = new URL("project/history/work-dependency/WDB-PM-001-001/WDA-GATE-PROMOTION-PM-001-001/", ROOT);

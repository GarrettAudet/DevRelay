...
const integrationSummary = readJson(
  "dogfood/ep-001-environment-preparation/integration-frontier-2/integration-summary.json",
);
...
const completionsValue = readJson(
  "dogfood/ep-001-environment-preparation/frontier-3/integrated-completion-fact-set.json",
);
const completions = canonicalLoaded(
  completionsValue,
  "ICFS-EP-001-FRONTIER-3",
...
const jobs = [
  { workItemId: "WI-EP-PREPARATION-EFFECTS", attemptId: "ATT-EP-PREPARATION-EFFECTS-001", files: ["src/environment-preparation-effects.mjs", "test/environment-preparation-effects.test.mjs", "src/index.mjs"], command: "node --test test/environment-preparation-effects.test.mjs", tests: 9 },
];
const permissions = [
...
const graphHeadPath =
  "dogfood/ep-001-environment-preparation/integration-frontier-2/WI-EP-PROFILE-INVENTORY/traceability-graph-snapshot.json";
...
const summary = {
  apiVersion: API,
  kind: "Ep001FrontierThreeExecutionSummary",

...
const firstFacts = [
  readJson("dogfood/ep-001-environment-preparation/frontier-3/COMPLETION-WI-EP-ARTIFACT-CONTRACTS-001.json"),
  readJson("dogfood/ep-001-environment-preparation/frontier-3/COMPLETION-WI-EP-PROFILE-INVENTORY-001.json"),
];
const execution = readJson("dogfood/ep-001-environment-preparation/execution-frontier-3/execution-summary.json");
const verification = readJson("dogfood/ep-001-environment-preparation/verification-frontier-3/verification-summary.json");
const integration = readJson("dogfood/ep-001-environment-preparation/integration-frontier-3/integration-summary.json");
...
const readyFrontier = deriveReadyFrontier({ baseline, completionFacts, frontierId: "FRONTIER-EP-001-004" });

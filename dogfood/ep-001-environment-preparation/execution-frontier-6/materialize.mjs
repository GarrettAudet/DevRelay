...
const jobs = [
  { workItemId: "WI-EP-REGRESSION-PERFORMANCE", attemptId: "ATT-EP-REGRESSION-PERFORMANCE-001", files: ["test/environment-preparation-regression-performance.test.mjs"], command: "node --test test/environment-preparation-regression-performance.test.mjs", tests: 6 },
];
const permissions = [
...
const graphHeadPath =
  "dogfood/ep-001-environment-preparation/integration-frontier-5/WI-EP-TRACEABILITY/traceability-graph-snapshot.json";
...
const summary = {
  apiVersion: API,
  kind: "Ep001FrontierSixExecutionSummary",

...
const completionsValue = readJson(
  "dogfood/ep-001-environment-preparation/frontier-6/integrated-completion-fact-set.json",
);
...
const jobs = [
  { workItemId: "WI-EP-REGRESSION-PERFORMANCE", attemptId: "ATT-EP-REGRESSION-PERFORMANCE-002", files: ["test/pm001-final-release.test.mjs", "test/project-baseline.test.mjs"], command: "node --test test/pm001-final-release.test.mjs test/project-baseline.test.mjs", tests: 3 },
];
const permissions = [
...
const graphHeadPath =
  "dogfood/ep-001-environment-preparation/integration-system-fix-1/WI-EP-TRACEABILITY/traceability-graph-snapshot.json";

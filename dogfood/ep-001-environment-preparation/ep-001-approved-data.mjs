...
export function buildEnvironmentPreparationRequirements(currentRequirements, makeSourceRefs) {
  ...
  const stories = [
    ["US-DEV-ENVIRONMENT-PROFILE-001", "CAP-DEV-ENVIRONMENT-PROFILE-001", "Declare the exact host and project environments needed by approved work.", "Environment expectations are explicit rather than inferred by an executor.", ["AC-EP-BASELINE-001", "AC-EP-BOUNDARY-001", "AC-EP-MODEL-001", "AC-EP-PROFILE-001", "AC-EP-SUPPORT-001"]],

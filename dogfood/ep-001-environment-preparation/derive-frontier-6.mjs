...
const outputRoot = fileURLToPath(new URL("./frontier-6/", import.meta.url));
...
const priorFacts = [
  readJson(
    "dogfood/ep-001-environment-preparation/frontier-5/COMPLETION-WI-EP-ARTIFACT-CONTRACTS-001.json",
  ),
  readJson(
    "dogfood/ep-001-environment-preparation/frontier-5/COMPLETION-WI-EP-PROFILE-INVENTORY-001.json",
  ),
  readJson(
    "dogfood/ep-001-environment-preparation/frontier-5/COMPLETION-WI-EP-PREPARATION-EFFECTS-001.json",
  ),  readJson(
    "dogfood/ep-001-environment-preparation/frontier-5/COMPLETION-WI-EP-GATE-READINESS-001.json",
  ),
  readJson(
    "dogfood/ep-001-environment-preparation/frontier-5/COMPLETION-WI-EP-OPTIONAL-ADAPTERS-001.json",
  ),
];
const execution = readJson(
  "dogfood/ep-001-environment-preparation/execution-frontier-5/execution-summary.json",
);
const verification = readJson(
  "dogfood/ep-001-environment-preparation/verification-frontier-5/verification-summary.json",
);
const integration = readJson(
  "dogfood/ep-001-environment-preparation/integration-frontier-5/integration-summary.json",
);
...
const readyFrontier = deriveReadyFrontier({
  baseline,
  completionFacts,
  frontierId: "FRONTIER-EP-001-006",
});

# Bind readiness to exact fingerprints and revalidate every frontier
...
- OPT-EP-EXACT-REVALIDATION
- OPT-EP-SESSION-LONG-READY

## Decision Outcome

Chosen option: "OPT-EP-EXACT-REVALIDATION", because it preserves the approved authority boundary. The selected boundary preserves Core-owned routing, closure, validation, checkpointing, traceability, and Gate authority while allowing bounded best-in-class capabilities to be swapped.

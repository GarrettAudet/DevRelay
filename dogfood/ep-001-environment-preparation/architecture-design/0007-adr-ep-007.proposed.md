# Use single-attempt readiness receipts and forward-only traceability
...
- OPT-EP-ATTEMPT-BOUND-RECEIPT
- OPT-EP-REUSABLE-READY-FLAG

## Decision Outcome

Chosen option: "OPT-EP-ATTEMPT-BOUND-RECEIPT", because it preserves the approved authority boundary. The selected boundary preserves Core-owned routing, closure, validation, checkpointing, traceability, and Gate authority while allowing bounded best-in-class capabilities to be swapped.

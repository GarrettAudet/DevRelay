...
export async function promoteEnvironmentArchitecture(context) {
  const {
    root,
    dir,
    read,
  ...
  const ownerApprovalBytes = read(
    "dogfood/ep-001-environment-preparation/architecture-design/architecture-gate-owner-approval.json",
  );
  ...
  const gateReviewRef = fileRef(
    "architecture-gate-review-ep-001-environment-preparation-v1",
  ...
  const executionProofRef = fileRef(
    "architecture-dogfood-execution-proof-ep-001-environment-preparation-v1",
  ...
  const promotedBaseline = {
    ...
    baselineId: "architecture-baseline-devrelay-v1-ep-001-environment-preparation-001",
  ...
  const promotedProjectState = {
    ...
    stateId: "project-architecture-state-devrelay-ep-001-environment-preparation-approved-v1",
    state: "baselined",
  ...
  const promotionId = "architecture-promotion-ep-001-environment-preparation-v1";

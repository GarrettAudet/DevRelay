workspace "DevRelay EP-001 EnvironmentPreparation/Verification" "Profile-bound environment preparation, verification, readiness, and execution authorization" {
  !identifiers flat

# Keep secret values absent and network denied by default
...
- OPT-EP-REFERENCES-OFFLINE
- OPT-EP-ENV-DUMP-ONLINE

## Decision Outcome

Chosen option: "OPT-EP-REFERENCES-OFFLINE", because it preserves the approved authority boundary. The selected boundary preserves Core-owned routing, closure, validation, checkpointing, traceability, and Gate authority while allowing bounded best-in-class capabilities to be swapped.

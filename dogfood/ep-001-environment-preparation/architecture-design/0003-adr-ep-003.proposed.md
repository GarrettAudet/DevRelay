# Ship native Windows inventory and capability-oriented optional adapters
...
- OPT-EP-NATIVE-PLUS-CAPABILITIES
- OPT-EP-TOOL-SPECIFIC-CORE

## Decision Outcome

Chosen option: "OPT-EP-NATIVE-PLUS-CAPABILITIES", because it preserves the approved authority boundary. The selected boundary preserves Core-owned routing, closure, validation, checkpointing, traceability, and Gate authority while allowing bounded best-in-class capabilities to be swapped.

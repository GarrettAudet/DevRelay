# Default to project-local reversible preparation
...
- OPT-EP-PROJECT-LOCAL
- OPT-EP-GLOBAL-AUTOMATION

## Decision Outcome

Chosen option: "OPT-EP-PROJECT-LOCAL", because it preserves the approved authority boundary. The selected boundary preserves Core-owned routing, closure, validation, checkpointing, traceability, and Gate authority while allowing bounded best-in-class capabilities to be swapped.

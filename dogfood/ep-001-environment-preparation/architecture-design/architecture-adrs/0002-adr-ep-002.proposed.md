# Model the DevRelay host and named project profiles as distinct layers
...
- OPT-EP-TWO-LAYER-PROFILES
- OPT-EP-SINGLE-HOST-INFERENCE

## Decision Outcome

Chosen option: "OPT-EP-TWO-LAYER-PROFILES", because it preserves the approved authority boundary. The selected boundary preserves Core-owned routing, closure, validation, checkpointing, traceability, and Gate authority while allowing bounded best-in-class capabilities to be swapped.

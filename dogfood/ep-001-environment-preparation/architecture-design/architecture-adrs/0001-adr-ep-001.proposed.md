# Separate EnvironmentPreparation candidates from EnvironmentVerificationGate authority
...
- OPT-EP-MODULE-GATE-SPLIT
- OPT-EP-PREPARER-SELF-APPROVES

## Decision Outcome

Chosen option: "OPT-EP-MODULE-GATE-SPLIT", because it preserves the approved authority boundary. The selected boundary preserves Core-owned routing, closure, validation, checkpointing, traceability, and Gate authority while allowing bounded best-in-class capabilities to be swapped.

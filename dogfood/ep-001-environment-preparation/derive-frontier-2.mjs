...
const execution = readJson(
  "dogfood/ep-001-environment-preparation/execution-frontier-1/execution-summary.json",
);
const verification = readJson(
  "dogfood/ep-001-environment-preparation/verification-frontier-1/verification-summary.json",
);
...
const readyFrontier = deriveReadyFrontier({
  baseline,
  completionFacts,
  frontierId: "FRONTIER-EP-001-002",
});

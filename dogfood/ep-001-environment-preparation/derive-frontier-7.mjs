...
const priorFacts = [
  readJson(
    "dogfood/ep-001-environment-preparation/frontier-6/COMPLETION-WI-EP-ARTIFACT-CONTRACTS-001.json",
  ),
  readJson(
    "dogfood/ep-001-environment-preparation/frontier-6/COMPLETION-WI-EP-PROFILE-INVENTORY-001.json",
  ),
  readJson(
    "dogfood/ep-001-environment-preparation/frontier-6/COMPLETION-WI-EP-PREPARATION-EFFECTS-001.json",
  ),  readJson(
    "dogfood/ep-001-environment-preparation/frontier-6/COMPLETION-WI-EP-GATE-READINESS-001.json",
  ),
  readJson(
    "dogfood/ep-001-environment-preparation/frontier-6/COMPLETION-WI-EP-OPTIONAL-ADAPTERS-001.json",
  ),
  readJson(
    "dogfood/ep-001-environment-preparation/frontier-6/COMPLETION-WI-EP-DESKTOP-INTEGRATION-001.json",
  ),
  readJson(
    "dogfood/ep-001-environment-preparation/frontier-6/COMPLETION-WI-EP-TRACEABILITY-001.json",
  ),
];
const execution = readJson(
  "dogfood/ep-001-environment-preparation/execution-frontier-6/execution-summary.json",
);
const verification = readJson(
  "dogfood/ep-001-environment-preparation/verification-frontier-6/verification-summary.json",
);

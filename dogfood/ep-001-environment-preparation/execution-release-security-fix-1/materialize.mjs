...
const jobs = [
  { workItemId: "WI-EP-WINDOWS-E2E", attemptId: "ATT-EP-WINDOWS-E2E-002", files: ["dogfood/ep-001-environment-preparation/windows-e2e/installed-scenario.mjs", "test/environment-preparation-windows-e2e.test.mjs"], command: "node --test test/environment-preparation-windows-e2e.test.mjs", tests: 5 },
];
const permissions = [
...
const summary = {
  apiVersion: API,
  kind: "Ep001ReleaseSecurityRepairExecutionSummary",

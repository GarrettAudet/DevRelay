...
const integrationSummary = readJson(
  "dogfood/ep-001-environment-preparation/integration-frontier-6/integration-summary.json",
);
...
const repository = canonicalLoaded(
  {
    ...
    includedPaths: ["dogfood/ep-001-environment-preparation/windows-e2e/**", "src/**", "test/**"],
...
const completionsValue = readJson(
  "dogfood/ep-001-environment-preparation/frontier-7/integrated-completion-fact-set.json",
);
const completions = canonicalLoaded(
  completionsValue,
  "ICFS-EP-001-FRONTIER-7",
...
const jobs = [
  { workItemId: "WI-EP-WINDOWS-E2E", attemptId: "ATT-EP-WINDOWS-E2E-001", files: ["dogfood/ep-001-environment-preparation/windows-e2e/installed-package-verification-receipt.json", "dogfood/ep-001-environment-preparation/windows-e2e/installed-scenario-receipt.json", "dogfood/ep-001-environment-preparation/windows-e2e/installed-scenario.mjs", "dogfood/ep-001-environment-preparation/windows-e2e/materialize.mjs", "dogfood/ep-001-environment-preparation/windows-e2e/npm-install-command-receipt.json", "dogfood/ep-001-environment-preparation/windows-e2e/npm-pack-command-receipt.json", "dogfood/ep-001-environment-preparation/windows-e2e/raw/installed-scenario.stderr.txt", "dogfood/ep-001-environment-preparation/windows-e2e/raw/installed-scenario.stdout.txt", "dogfood/ep-001-environment-preparation/windows-e2e/raw/npm-install.stderr.txt", "dogfood/ep-001-environment-preparation/windows-e2e/raw/npm-install.stdout.txt", "dogfood/ep-001-environment-preparation/windows-e2e/raw/npm-pack.stderr.txt", "dogfood/ep-001-environment-preparation/windows-e2e/raw/npm-pack.stdout.txt", "dogfood/ep-001-environment-preparation/windows-e2e/scenario-command-receipt.json", "dogfood/ep-001-environment-preparation/windows-e2e/windows-e2e-summary.json", "dogfood/ep-001-environment-preparation/windows-e2e/WindowsDesktopE2EReport.md", "test/environment-preparation-windows-e2e.test.mjs"], command: "node --test test/environment-preparation-windows-e2e.test.mjs", tests: 4 },
];
const permissions = [
  { kind: "filesystem.write", scope: { values: ["README.md", "docs/**", "dogfood/ep-001-environment-preparation/windows-e2e/**", "examples/**", "package.json", "src/**", "test/**"] } },
  { kind: "process.spawn", scope: { values: ["node"] } },
];

const graphHeadPath =
  "dogfood/ep-001-environment-preparation/integration-frontier-6/WI-EP-REGRESSION-PERFORMANCE/traceability-graph-snapshot.json";
...
const summary = {
  apiVersion: API,
  kind: "Ep001FrontierSevenExecutionSummary",
...
for (const job of jobs) {
  ...
  const moduleInvocation = {
    ...
    invocationId: `WE-EP-001-${item.id}`,
    module: {
      id: "work-execution",
      version: "0.1.0",

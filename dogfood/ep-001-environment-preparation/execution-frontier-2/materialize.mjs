...
const integrationSummary = readJson(
  "dogfood/ep-001-environment-preparation/integration-frontier-1/integration-summary.json",
);
...
const completionsValue = readJson(
  "dogfood/ep-001-environment-preparation/frontier-2/integrated-completion-fact-set.json",
);
const completions = canonicalLoaded(
  completionsValue,
  "ICFS-EP-001-FRONTIER-2",
...
const jobs = [
  {
    workItemId: "WI-EP-PROFILE-INVENTORY",
    attemptId: "ATT-EP-PROFILE-INVENTORY-001",
    files: ["src/environment-preparation-profile-inventory.mjs", "test/environment-preparation-profile-inventory.test.mjs", "src/index.mjs"],
    command: "node --test test/environment-preparation-profile-inventory.test.mjs",
    tests: 8,
  },
];
const permissions = [
...
const graphHeadPath =
  "dogfood/ep-001-environment-preparation/integration-frontier-1/WI-EP-ARTIFACT-CONTRACTS/traceability-graph-snapshot.json";
...
const summary = {
  apiVersion: API,
  kind: "Ep001FrontierTwoExecutionSummary",

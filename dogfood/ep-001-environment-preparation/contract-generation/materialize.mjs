...
const RUN_ID = "ep-001-environment-preparation-contract-change-run-v1";
const INVOCATION_ID = "contract-generation-change-ep-001-environment-preparation-v1";
const GRAPH_ID = "devrelay/ep-001-environment-preparation-contract-change";
...
const state = await exactJsonFile(
  "project-contract-state.json",
  {
    ...
    stateId: "PCS-DEVRELAY-CONTRACTS-EP-001-001",
    state: "baselined",
  ...
  "PCS-DEVRELAY-CONTRACTS-EP-001-001",
);
...
const executionRecordFile = await exactJsonFile(
  ...
  "MER-CONTRACT-CHANGE-EP-001-001",
);
...
const gateReview = await exactJsonFile(
  "contract-gate-review.json",
  {
    ...
    reviewId: "CGR-EP-001-CONTRACT-CHANGE-001",
...
const gateCandidate = await exactJsonFile(
  "contract-gate-candidate.json",
  {
    ...
    gateCandidateId: "CGC-EP-001-001",
    candidate: execution.candidateRef,
    architectureBaseline: architecture.ref,
    projectOverviewBaseline: projectOverview.ref,

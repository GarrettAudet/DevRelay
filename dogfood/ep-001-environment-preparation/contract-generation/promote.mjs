...
const DISPLACED_CONTEXT = new URL("history/pre-ep-001-contract-promotion/", WORK_BREAKDOWN_CONTEXT);
const APPROVED = Object.freeze({
  candidate: "sha256:7289613276c07d5399741fc36b8a41f110861ccb3ba2f2759c795b1b76152f30",
  gateReview: "sha256:0d75b24ab6f87c11ee2a8805ae780c858d09b5130290c55bcfd4f2aaa64cda73",
  gateCandidate: "sha256:4f1840d84321ef5d752b57e8fb630768738ddd544b9716c47ce4d9fec3e642a8",
  checkpoint: "sha256:7ac0eda48cbe60d8679fd7af7fbcb539e82495f92bc715f586e4b708580080d8",
  traceabilityUpdate: "sha256:6985f5cdbfba1a27444608f1083f78bd2d8486dabee1f17df84232ed3df269b6",
  executionRecord: "sha256:9e74113c4f51aa04169c778a632f49165b7311aa7442c61c5674ffa853c07876",
});
...
const approvalValue = {
  ...
  approvalId: "CGA-EP-001-CONTRACT-CHANGE-001",
...
const stateValue = {
  ...
  stateId: "PCS-DEVRELAY-CONTRACTS-EP-001-BASELINED-001",
  state: "baselined",
  architectureBaseline: dogfood.architecture.ref,
  projectOverviewBaseline: dogfood.projectOverview.ref,
...
const upstreamGraph = createTraceabilityGraphService({
  graphId: "devrelay/ep-001-contract-generation-promotion",
  projectId: "devrelay",
  store: graphStore,
  contributors: [
...
const gateInvocation = {
  invocationId: "contract-gate-promotion-ep-001-v1",
...
const promotionValue = {
  ...
  promotionId: "CGP-EP-001-CONTRACT-CHANGE-001",
  candidate: dogfood.candidateLoaded.ref,
...
await preserveAndReplaceCurrent(
  ...
  new URL("project/history/contracts/CB-DEVRELAY-013/contract-baseline.json", ROOT),
);
await preserveAndReplaceCurrent(
  disposition,
  new URL("project/contract-disposition.json", ROOT),
  new URL("project/history/contracts/CB-DEVRELAY-013/contract-disposition.json", ROOT),
);
await preserveAndReplaceCurrent(
  promotion,
  new URL("project/contract-gate-promotion.json", ROOT),
  new URL("project/history/contracts/CB-DEVRELAY-013/contract-gate-promotion.json", ROOT),
);
await preserveAndReplaceCurrent(
  state,
  new URL("project/project-contract-state.json", ROOT),
  new URL("project/history/contracts/CB-DEVRELAY-013/project-contract-state.pre-ep-001.json", ROOT),
);

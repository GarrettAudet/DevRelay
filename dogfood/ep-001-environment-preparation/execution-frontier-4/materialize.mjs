...
const integrationSummary = readJson(
  "dogfood/ep-001-environment-preparation/integration-frontier-3/integration-summary.json",
);
...
const completionsValue = readJson(
  "dogfood/ep-001-environment-preparation/frontier-4/integrated-completion-fact-set.json",
);
const completions = canonicalLoaded(
  completionsValue,
  "ICFS-EP-001-FRONTIER-4",
...
const jobs = [
  { workItemId: "WI-EP-GATE-READINESS", attemptId: "ATT-EP-GATE-READINESS-001", files: ["src/environment-preparation-gate.mjs", "test/environment-preparation-gate.test.mjs"], command: "node --test test/environment-preparation-gate.test.mjs", tests: 9 },
  { workItemId: "WI-EP-OPTIONAL-ADAPTERS", attemptId: "ATT-EP-OPTIONAL-ADAPTERS-001", files: ["src/environment-preparation-adapters.mjs", "test/environment-preparation-adapters.test.mjs"], command: "node --test test/environment-preparation-adapters.test.mjs", tests: 8 },
];
const permissions = [
...
const graphHeadPath =
  "dogfood/ep-001-environment-preparation/integration-frontier-3/WI-EP-PREPARATION-EFFECTS/traceability-graph-snapshot.json";
...
const summary = {
  apiVersion: API,
  kind: "Ep001FrontierFourExecutionSummary",

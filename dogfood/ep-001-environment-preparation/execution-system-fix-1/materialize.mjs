...
const jobs = [
  { workItemId: "WI-EP-TRACEABILITY", attemptId: "ATT-EP-TRACEABILITY-002", files: ["src/traceability-artifact-validator.mjs", "test/business-acceptance-traceability.test.mjs"], command: "node --test test/business-acceptance-traceability.test.mjs test/traceability-vocabulary-migration.test.mjs", tests: 10 },
];
const permissions = [
...
const graphHeadPath =
  "dogfood/ep-001-environment-preparation/integration-frontier-7/WI-EP-WINDOWS-E2E/traceability-graph-snapshot.json";
...
const summary = {
  apiVersion: API,
  kind: "Ep001SystemVerificationRepairExecutionSummary",

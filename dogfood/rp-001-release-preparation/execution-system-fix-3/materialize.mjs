...
const integrationSummary = readJson(
  "dogfood/rp-001-release-preparation/integration-system-fix-2/integration-summary.json",
);
...
const jobs = [
  {
    workItemId: "WI-RP-WINDOWS-E2E",
    attemptId: "ATT-RP-WINDOWS-E2E-003",
    files: [
      "project/architecture-gate-owner-approval-rp-001-release-preparation-v1.json",
      "project/architecture-promotion.commit.json",
      "project/architecture-promotion.pending.json",
      "project/contract-baseline.json",
      "project/contract-gate-promotion.json",
      "project/history/2.3.0/ProjectOverview.md",
      "project/history/2.3.0/project-overview-baseline.json",
      "project/history/2.3.0/requirements-baseline.json",
      "project/history/architecture/architecture-baseline-devrelay-v1-ep-001-environment-preparation-001/architecture-baseline.json",
      "project/history/architecture/architecture-baseline-devrelay-v1-ep-001-environment-preparation-001/architecture-promotion.commit.json",
      "project/history/architecture/architecture-baseline-devrelay-v1-ep-001-environment-preparation-001/architecture-promotion.pending.json",
      "project/history/architecture/architecture-baseline-devrelay-v1-ep-001-environment-preparation-001/project-architecture-state.json",
      "project/history/contracts/CB-DEVRELAY-014/contract-baseline.json",
      "project/history/contracts/CB-DEVRELAY-014/contract-disposition.json",
      "project/history/contracts/CB-DEVRELAY-014/contract-gate-promotion.json",
      "project/history/contracts/CB-DEVRELAY-014/project-contract-state.pre-rp-001.json",
      "project/history/specialist-assignment/SAB-BFBBA9A477BFD0F8/specialist-assignment-baseline.json",
      "project/history/specialist-assignment/SAB-BFBBA9A477BFD0F8/specialist-assignment-promotion.commit.json",
      "project/history/work-breakdown/2.3.0/project-work-breakdown-state.json",
      "project/history/work-breakdown/2.3.0/work-breakdown-baseline.json",
      "project/history/work-breakdown/2.3.0/work-breakdown-promotion.commit.json",
      "project/history/work-breakdown/2.3.0/work-breakdown-promotion.pending.json",
      "project/history/work-dependency/WDB-EP-001-001/WDA-GATE-PROMOTION-EP-001-001/work-dependency-baseline.json",
      "project/history/work-dependency/WDB-EP-001-001/WDA-GATE-PROMOTION-EP-001-001/work-dependency-promotion.commit.json",
      "project/project-architecture-state.json",
      "project/project-contract-state.json",
      "project/project-work-breakdown-state.json",
      "project/requirements-gate-rp-001-release-preparation-v1.md",
      "project/requirements-promotion.commit.json",
      "project/requirements-promotion.pending.json",
      "project/specialist-assignment-promotion.commit.json",
      "project/work-breakdown-promotion.commit.json",
      "project/work-breakdown-promotion.pending.json",
      "project/work-dependency-promotion.commit.json",
      "release/0.10.0-rc.3.json",
    ],
    command: "node --test test/project-baseline.test.mjs && node scripts/check-release-manifest.mjs (isolated candidate checkout)",
    tests: 2,
  },
];
const permissions = [
  { kind: "filesystem.write", scope: { values: ["project/**", "release/**"] } },
  { kind: "process.spawn", scope: { values: ["node"] } },
];

const graphHeadPath =
  "dogfood/rp-001-release-preparation/integration-system-fix-2/WI-RP-WINDOWS-E2E/traceability-graph-snapshot.json";
...
const summary = {
  apiVersion: API,
  kind: "Rp001ProjectBaselineClosureRepairExecutionSummary",

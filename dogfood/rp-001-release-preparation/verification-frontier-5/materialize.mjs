...
const verificationRoot = resolve(root, "dogfood/rp-001-release-preparation/verification-frontier-5");
mkdirSync(verificationRoot, { recursive: true });

const verificationJobs = Object.freeze({
  "WI-RP-GATE-SUMMARY": Object.freeze({ argv: ["--test", "test/release-preparation-gate.test.mjs", "test/release-preparation-artifacts.test.mjs", "test/release-preparation-verification.test.mjs"], command: "node --test test/release-preparation-gate.test.mjs test/release-preparation-artifacts.test.mjs test/release-preparation-verification.test.mjs", tests: 18 }),
});
...
const baselines = {
  ...
  repositoryBase: readJson("dogfood/rp-001-release-preparation/integration-frontier-4/WI-RP-VERIFY-POLICY/post-repository-snapshot.json"),
};
...
for (const workItemId of workItemIds) {
  ...
  const executionDir = `dogfood/rp-001-release-preparation/execution-frontier-5/${workItemId}`;
...
const summary = { apiVersion: "devrelay.dev/v1alpha1", kind: "Rp001FifthFrontierVerificationSummary", results };

...
const firstFacts = [
  readJson("dogfood/rp-001-release-preparation/frontier-3/COMPLETION-WI-RP-ARTIFACT-CONTRACTS-001.json"),
  readJson("dogfood/rp-001-release-preparation/frontier-3/COMPLETION-WI-RP-IDENTITY-ROUTING-001.json"),
];
const execution = readJson("dogfood/rp-001-release-preparation/execution-frontier-3/execution-summary.json");
const verification = readJson("dogfood/rp-001-release-preparation/verification-frontier-3/verification-summary.json");
const integration = readJson("dogfood/rp-001-release-preparation/integration-frontier-3/integration-summary.json");
...
const readyFrontier = deriveReadyFrontier({ baseline, completionFacts, frontierId: "FRONTIER-RP-001-004" });

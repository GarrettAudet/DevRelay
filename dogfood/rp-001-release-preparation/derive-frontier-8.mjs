...
const firstFacts = [
  readJson("dogfood/rp-001-release-preparation/frontier-7/COMPLETION-WI-RP-ADAPTER-EFFECTS-001.json"),
  readJson("dogfood/rp-001-release-preparation/frontier-7/COMPLETION-WI-RP-ARTIFACT-CONTRACTS-001.json"),
  readJson("dogfood/rp-001-release-preparation/frontier-7/COMPLETION-WI-RP-GATE-SUMMARY-001.json"),
  readJson("dogfood/rp-001-release-preparation/frontier-7/COMPLETION-WI-RP-IDENTITY-ROUTING-001.json"),
  readJson("dogfood/rp-001-release-preparation/frontier-7/COMPLETION-WI-RP-NATIVE-MATERIALIZATION-001.json"),
  readJson("dogfood/rp-001-release-preparation/frontier-7/COMPLETION-WI-RP-TRACEABILITY-001.json"),
  readJson("dogfood/rp-001-release-preparation/frontier-7/COMPLETION-WI-RP-VERIFY-POLICY-001.json"),
];
const execution = readJson("dogfood/rp-001-release-preparation/execution-frontier-7/execution-summary.json");
const verification = readJson("dogfood/rp-001-release-preparation/verification-frontier-7/verification-summary.json");
const integration = readJson("dogfood/rp-001-release-preparation/integration-frontier-7/integration-summary.json");
...
const readyFrontier = deriveReadyFrontier({ baseline, completionFacts, frontierId: "FRONTIER-RP-001-008" });

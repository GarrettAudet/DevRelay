...
const jobs = [
  {
    workItemId: "WI-RP-ARTIFACT-CONTRACTS",
    attemptId: "ATT-RP-ARTIFACT-CONTRACTS-001",
    files: [
      "contracts/release-preparation-artifacts.schema.json",
      "src/release-preparation-artifact-validator.mjs",
...
const graphHeadPath =
  "dogfood/rp-001-release-preparation/assignment/promotion/traceability-graph-snapshot.json";
...
const summary = {
  apiVersion: API,
  kind: "Rp001FrontierOneExecutionSummary",

...
const firstFacts = [
  readJson("dogfood/rp-001-release-preparation/frontier-2/COMPLETION-WI-RP-ARTIFACT-CONTRACTS-001.json"),
];
const execution = readJson("dogfood/rp-001-release-preparation/execution-frontier-2/execution-summary.json");
const verification = readJson("dogfood/rp-001-release-preparation/verification-frontier-2/verification-summary.json");
const integration = readJson("dogfood/rp-001-release-preparation/integration-frontier-2/integration-summary.json");
const integratedRefs = new Map([
  ["WI-RP-IDENTITY-ROUTING", integration.results[0].integratedChange],
]);
...
const readyFrontier = deriveReadyFrontier({ baseline, completionFacts, frontierId: "FRONTIER-RP-001-003" });

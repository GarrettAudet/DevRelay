...
const integrationSummary = readJson(
  "dogfood/rp-001-release-preparation/integration-frontier-3/integration-summary.json",
);
...
const completionsValue = readJson(
  "dogfood/rp-001-release-preparation/frontier-4/integrated-completion-fact-set.json",
);
const completions = canonicalLoaded(
  completionsValue,
  "ICFS-RP-001-FRONTIER-4",
...
const jobs = [
  { workItemId: "WI-RP-ADAPTER-EFFECTS", attemptId: "ATT-RP-ADAPTER-EFFECTS-001", files: ["src/release-preparation-adapters.mjs", "test/release-preparation-adapters.test.mjs"], command: "node --test test/release-preparation-adapters.test.mjs", tests: 6 },
  { workItemId: "WI-RP-VERIFY-POLICY", attemptId: "ATT-RP-VERIFY-POLICY-001", files: ["src/release-preparation-verification.mjs", "test/release-preparation-verification.test.mjs", "src/index.mjs"], command: "node --test test/release-preparation-verification.test.mjs", tests: 6 },
];
const permissions = [
...
const graphHeadPath =
  "dogfood/rp-001-release-preparation/integration-frontier-3/WI-RP-NATIVE-MATERIALIZATION/traceability-graph-snapshot.json";
...
const summary = {
  apiVersion: API,
  kind: "Rp001FrontierFourExecutionSummary",

...
const integrationSummary = readJson(
  "dogfood/rp-001-release-preparation/integration-frontier-1/integration-summary.json",
);
...
const completionsValue = readJson(
  "dogfood/rp-001-release-preparation/frontier-2/integrated-completion-fact-set.json",
);
const completions = canonicalLoaded(
  completionsValue,
  "ICFS-RP-001-FRONTIER-2",
...
const jobs = [
  {
    workItemId: "WI-RP-IDENTITY-ROUTING",
    attemptId: "ATT-RP-IDENTITY-ROUTING-001",
    files: ["src/release-preparation-identity-routing.mjs", "test/release-preparation-identity-routing.test.mjs", "src/index.mjs"],
    command: "node --test test/release-preparation-identity-routing.test.mjs",
    tests: 8,
  },
];
const permissions = [
...
const graphHeadPath =
  "dogfood/rp-001-release-preparation/integration-frontier-1/WI-RP-ARTIFACT-CONTRACTS/traceability-graph-snapshot.json";
...
const summary = {
  apiVersion: API,
  kind: "Rp001FrontierTwoExecutionSummary",

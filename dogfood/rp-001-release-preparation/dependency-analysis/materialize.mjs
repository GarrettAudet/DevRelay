...
const REPOSITORY_REVISION = "1ff3cc4ebecf15aa9ed6a1629a480ef9c790fcd2";
...
const contextSliceSetValue = {
  ...
  sliceSetId: "CTXS-WDA-RP-001-001",
  slices: [
    createContextSlice({
      id: "CTX-WDA-RP-001-REQUIREMENTS",
    ...
    createContextSlice({
      id: "CTX-WDA-RP-001-ARCHITECTURE",
    ...
    createContextSlice({
      id: "CTX-WDA-RP-001-REPOSITORY-REVISION",
...
const gateReview = await exactJsonFile(
  "work-dependency-gate-review.json",
  {
    ...
    reviewId: "WDA-GATE-REVIEW-RP-001-001",
...
const gateCandidate = await exactJsonFile(
  "gate-candidate.json",
  {
    ...
    gateCandidateId: "WDA-GATE-CANDIDATE-RP-001-001",
    candidate: execution.candidateRef,
    workBreakdownBaseline: workBreakdown.ref,

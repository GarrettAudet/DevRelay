...
const firstFacts = [
  readJson("dogfood/rp-001-release-preparation/frontier-4/COMPLETION-WI-RP-ARTIFACT-CONTRACTS-001.json"),
  readJson("dogfood/rp-001-release-preparation/frontier-4/COMPLETION-WI-RP-IDENTITY-ROUTING-001.json"),
  readJson("dogfood/rp-001-release-preparation/frontier-4/COMPLETION-WI-RP-NATIVE-MATERIALIZATION-001.json"),
];
const execution = readJson("dogfood/rp-001-release-preparation/execution-frontier-4/execution-summary.json");
const verification = readJson("dogfood/rp-001-release-preparation/verification-frontier-4/verification-summary.json");
const integration = readJson("dogfood/rp-001-release-preparation/integration-frontier-4/integration-summary.json");
...
const readyFrontier = deriveReadyFrontier({ baseline, completionFacts, frontierId: "FRONTIER-RP-001-005" });

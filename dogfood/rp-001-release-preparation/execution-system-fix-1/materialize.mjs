...
const integrationSummary = readJson(
  "dogfood/rp-001-release-preparation/integration-frontier-8/integration-summary.json",
);
...
const completionsValue = readJson(
  "dogfood/rp-001-release-preparation/frontier-6/integrated-completion-fact-set.json",
);
const completions = canonicalLoaded(
  completionsValue,
  "ICFS-RP-001-FRONTIER-6",
...
const jobs = [
  { workItemId: "WI-RP-TRACEABILITY", attemptId: "ATT-RP-TRACEABILITY-002", files: ["src/traceability-artifact-validator.mjs"], command: "node --test test/business-acceptance-traceability.test.mjs test/release-preparation-traceability.test.mjs", tests: 11 },
];
const permissions = [
...
const graphHeadPath =
  "dogfood/rp-001-release-preparation/integration-frontier-8/WI-RP-WINDOWS-E2E/traceability-graph-snapshot.json";
...
const summary = {
  apiVersion: API,
  kind: "Rp001SystemVerificationRepairExecutionSummary",

...
const integrationSummary = readJson(
  "dogfood/rp-001-release-preparation/integration-system-fix-3/integration-summary.json",
);
...
const jobs = [
  { workItemId: "WI-RP-WINDOWS-E2E", attemptId: "ATT-RP-WINDOWS-E2E-004", files: ["release/0.10.0-rc.3.json"], command: "node scripts/check-release-manifest.mjs (isolated candidate checkout)", tests: 1 },
];
const permissions = [
...
const graphHeadPath =
  "dogfood/rp-001-release-preparation/integration-system-fix-3/WI-RP-WINDOWS-E2E/traceability-graph-snapshot.json";
...
const summary = {
  apiVersion: API,
  kind: "Rp001FinalReleaseCatalogRepairExecutionSummary",

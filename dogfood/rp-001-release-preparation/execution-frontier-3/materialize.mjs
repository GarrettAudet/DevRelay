...
const integrationSummary = readJson(
  "dogfood/rp-001-release-preparation/integration-frontier-2/integration-summary.json",
);
...
const completionsValue = readJson(
  "dogfood/rp-001-release-preparation/frontier-3/integrated-completion-fact-set.json",
);
const completions = canonicalLoaded(
  completionsValue,
  "ICFS-RP-001-FRONTIER-3",
...
const jobs = [
  { workItemId: "WI-RP-NATIVE-MATERIALIZATION", attemptId: "ATT-RP-NATIVE-MATERIALIZATION-001", files: ["src/release-preparation-native-materializer.mjs", "test/release-preparation-native-materializer.test.mjs", "src/index.mjs"], command: "node --test test/release-preparation-native-materializer.test.mjs", tests: 8 },
];
const permissions = [
...
const graphHeadPath =
  "dogfood/rp-001-release-preparation/integration-frontier-2/WI-RP-IDENTITY-ROUTING/traceability-graph-snapshot.json";
...
const summary = {
  apiVersion: API,
  kind: "Rp001FrontierThreeExecutionSummary",

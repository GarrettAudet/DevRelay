# Keep execution offline and project-local by default with no implicit publication or credential authority
...
- OPT-RP-OFFLINE-NO-PUBLICATION
- OPT-RP-CONVENIENT-HOSTED-AUTOMATION

## Decision Outcome

Chosen option: "OPT-RP-OFFLINE-NO-PUBLICATION", because it preserves the approved authority boundary. The selected boundary preserves Core-owned routing, closure, validation, checkpointing, traceability, and Gate authority while allowing bounded best-in-class capabilities to be swapped.

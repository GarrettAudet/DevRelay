...
export async function promoteReleaseArchitecture(context) {
  const {
    root,
    dir,
    read,
  ...
  const ownerApprovalBytes = read(
    "dogfood/rp-001-release-preparation/architecture-design/architecture-gate-owner-approval.json",
  );
  ...
  const gateReviewRef = fileRef(
    "architecture-gate-review-rp-001-release-preparation-v1",
  ...
  const executionProofRef = fileRef(
    "architecture-dogfood-execution-proof-rp-001-release-preparation-v1",
  ...
  const promotedBaseline = {
    ...
    baselineId: "architecture-baseline-devrelay-v1-rp-001-release-preparation-001",
  ...
  const promotedProjectState = {
    ...
    stateId: "project-architecture-state-devrelay-rp-001-release-preparation-approved-v1",
    state: "baselined",
  ...
  const promotionId = "architecture-promotion-rp-001-release-preparation-v1";

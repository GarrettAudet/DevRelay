# Separate candidate and approved forward release traceability and keep adapters graph-blind
...
- OPT-RP-TRUSTED-FORWARD-SCOPES
- OPT-RP-ADAPTER-RELEASE-GRAPH

## Decision Outcome

Chosen option: "OPT-RP-TRUSTED-FORWARD-SCOPES", because it preserves the approved authority boundary. The selected boundary preserves Core-owned routing, closure, validation, checkpointing, traceability, and Gate authority while allowing bounded best-in-class capabilities to be swapped.

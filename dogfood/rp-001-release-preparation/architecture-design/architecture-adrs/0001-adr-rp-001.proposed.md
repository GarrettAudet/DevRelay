# Place conditional ReleasePreparation after SystemVerification and keep ReleaseVerificationGate separate before BusinessAcceptance
...
- OPT-RP-MODULE-GATE-SPLIT
- OPT-RP-SCRIPTS-OR-SELF-APPROVAL

## Decision Outcome

Chosen option: "OPT-RP-MODULE-GATE-SPLIT", because it preserves the approved authority boundary. The selected boundary preserves Core-owned routing, closure, validation, checkpointing, traceability, and Gate authority while allowing bounded best-in-class capabilities to be swapped.

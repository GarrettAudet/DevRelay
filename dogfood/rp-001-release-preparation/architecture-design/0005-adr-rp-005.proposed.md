# Verify stored bytes against one versioned obligation and supply-chain policy
...
- OPT-RP-STORED-BYTE-POLICY
- OPT-RP-ADAPTER-SELF-CERTIFICATION

## Decision Outcome

Chosen option: "OPT-RP-STORED-BYTE-POLICY", because it preserves the approved authority boundary. The selected boundary preserves Core-owned routing, closure, validation, checkpointing, traceability, and Gate authority while allowing bounded best-in-class capabilities to be swapped.

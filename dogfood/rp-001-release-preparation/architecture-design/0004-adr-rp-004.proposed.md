# Checkpoint exact prepared candidate bytes before progression and replay with zero effects
...
- OPT-RP-PREPARED-BYTES-CHECKPOINT
- OPT-RP-REBUILD-ON-VERIFY

## Decision Outcome

Chosen option: "OPT-RP-PREPARED-BYTES-CHECKPOINT", because it preserves the approved authority boundary. The selected boundary preserves Core-owned routing, closure, validation, checkpointing, traceability, and Gate authority while allowing bounded best-in-class capabilities to be swapped.

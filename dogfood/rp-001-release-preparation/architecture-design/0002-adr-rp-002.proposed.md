# Bind one immutable candidate identity to source, baselines, version, policy, toolchain, and environment readiness
...
- OPT-RP-EXACT-IDENTITY
- OPT-RP-VERSION-AND-WORKSPACE-INFERENCE

## Decision Outcome

Chosen option: "OPT-RP-EXACT-IDENTITY", because it preserves the approved authority boundary. The selected boundary preserves Core-owned routing, closure, validation, checkpointing, traceability, and Gate authority while allowing bounded best-in-class capabilities to be swapped.

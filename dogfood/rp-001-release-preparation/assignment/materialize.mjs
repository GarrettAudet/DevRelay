...
async function write(name, value) {
  ...
  return {
    ...
    ref: {
      ...
      uri: `devrelay-repo:///dogfood/rp-001-release-preparation/assignment/${name}`,
    },
  };
}
...
const repositoryContext = await read("dogfood/rp-001-release-preparation/repository-snapshot.json");
...
function a2aProfile({ slug, name, description, capabilityIds, toolIds, grantIds }) {
  ...
  const snapshot = {
    source: {
      ...
      uri: `fixture://devrelay/a2a/rp-001/${slug}.json`,
    },
    agentCard: card,
    toolIds,
    grantIds,
...
const gateCandidate = {
  ...
  gateCandidateId: "SA-GATE-CANDIDATE-RP-001-001",
...
const approval = {
  ...
  approvalId: "SA-GATE-APPROVAL-RP-001-001",
  decision: "approve",
...
const approvalRef = {
  ...
  uri: "devrelay-repo:///dogfood/rp-001-release-preparation/assignment/specialist-assignment-gate-owner-approval.json",
};
...
const proof = {
  ...
  proofId: "SA-DOGFOOD-PROOF-RP-001-001",
...
await write("a2a-agent-card-snapshot-set.json", {
  ...
  snapshotSetId: "A2A-SNAPSHOT-SET-RP-001-001",

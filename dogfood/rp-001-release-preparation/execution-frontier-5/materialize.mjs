...
const integrationSummary = readJson(
  "dogfood/rp-001-release-preparation/integration-frontier-4/integration-summary.json",
);
...
const completionsValue = readJson(
  "dogfood/rp-001-release-preparation/frontier-5/integrated-completion-fact-set.json",
);
const completions = canonicalLoaded(
  completionsValue,
  "ICFS-RP-001-FRONTIER-5",
...
const jobs = [
  { workItemId: "WI-RP-GATE-SUMMARY", attemptId: "ATT-RP-GATE-SUMMARY-001", files: ["src/release-preparation-gate.mjs", "test/release-preparation-gate.test.mjs", "src/release-preparation-artifact-validator.mjs", "src/release-preparation-verification.mjs", "src/index.mjs"], command: "node --test test/release-preparation-gate.test.mjs test/release-preparation-artifacts.test.mjs test/release-preparation-verification.test.mjs", tests: 18 },
];
const permissions = [
...
const graphHeadPath =
  "dogfood/rp-001-release-preparation/integration-frontier-4/WI-RP-VERIFY-POLICY/traceability-graph-snapshot.json";
...
const summary = {
  apiVersion: API,
  kind: "Rp001FrontierFiveExecutionSummary",

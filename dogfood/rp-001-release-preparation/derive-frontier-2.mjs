...
const execution = readJson(
  "dogfood/rp-001-release-preparation/execution-frontier-1/execution-summary.json",
);
const verification = readJson(
  "dogfood/rp-001-release-preparation/verification-frontier-1/verification-summary.json",
);
...
const readyFrontier = deriveReadyFrontier({
  baseline,
  completionFacts,
  frontierId: "FRONTIER-RP-001-002",
});

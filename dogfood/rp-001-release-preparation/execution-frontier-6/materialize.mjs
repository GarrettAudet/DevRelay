...
const integrationSummary = readJson(
  "dogfood/rp-001-release-preparation/integration-frontier-5/integration-summary.json",
);
...
const jobs = [
  { workItemId: "WI-RP-TRACEABILITY", attemptId: "ATT-RP-TRACEABILITY-001", files: ["src/release-preparation-traceability-contributor.mjs", "src/traceability-artifact-validator.mjs", "src/traceability-graph.mjs", "test/release-preparation-traceability.test.mjs", "src/index.mjs"], command: "node --test test/release-preparation-traceability.test.mjs", tests: 6 },
];
const permissions = [
...
const graphHeadPath =
  "dogfood/rp-001-release-preparation/integration-frontier-5/WI-RP-GATE-SUMMARY/traceability-graph-snapshot.json";
...
const summary = {
  apiVersion: API,
  kind: "Rp001FrontierSixExecutionSummary",

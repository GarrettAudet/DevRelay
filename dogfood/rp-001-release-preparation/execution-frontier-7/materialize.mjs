...
const integrationSummary = readJson(
  "dogfood/rp-001-release-preparation/integration-frontier-6/integration-summary.json",
);
...
const completionsValue = readJson(
  "dogfood/rp-001-release-preparation/frontier-7/integrated-completion-fact-set.json",
);
const completions = canonicalLoaded(
  completionsValue,
  "ICFS-RP-001-FRONTIER-7",
...
const jobs = [
  { workItemId: "WI-RP-REGRESSION", attemptId: "ATT-RP-REGRESSION-001", files: ["project/project-baseline-data.mjs", "src/traceability-artifact-validator.mjs", "test/project-baseline.test.mjs", "test/release-preparation-regression.test.mjs", "test/work-execution-traceability.test.mjs"], command: "node --test test/project-baseline.test.mjs test/release-preparation-regression.test.mjs test/work-execution-traceability.test.mjs", tests: 8 },
];
const permissions = [
  { kind: "filesystem.write", scope: { values: ["project/**", "src/**", "test/**"] } },
  { kind: "process.spawn", scope: { values: ["node"] } },
];

const graphHeadPath =
  "dogfood/rp-001-release-preparation/integration-frontier-6/WI-RP-TRACEABILITY/traceability-graph-snapshot.json";
...
const summary = {
  apiVersion: API,
  kind: "Rp001FrontierSevenExecutionSummary",

...
const input = JSON.parse(
  fs.readFileSync(path.join(directory, "requirements-interview-input.json"), "utf8"),
);
...
process.stdout.write(
  `${JSON.stringify({ outcome: result.outcome, assessment: result.assessment, wave: result.wave }, null, 2)}\n`,
);

...
const integrationSummary = readJson(
  "dogfood/pm-001-project-memory/integration-frontier-1/integration-summary.json",
);
...
const completionsValue = readJson(
  "dogfood/pm-001-project-memory/frontier-2/integrated-completion-fact-set.json",
);
const completions = canonicalLoaded(
  completionsValue,
  "ICFS-PM-001-FRONTIER-2",
...
const jobs = [
  {
    ...
    attemptId: "ATT-PM-NATIVE-ENGINE-001",
    files: ["src/project-memory.mjs", "test/project-memory.test.mjs"],
    command: "node --test test/project-memory.test.mjs test/project-memory-artifacts.test.mjs",
    tests: 21,
  },
];
const permissions = [
...
const graphHeadPath =
  "dogfood/pm-001-project-memory/integration-frontier-1/WI-PM-ARTIFACT-CONTRACTS/traceability-graph-snapshot.json";
...
const summary = {
  apiVersion: API,
  kind: "Pm001FrontierTwoExecutionSummary",

...
const verificationRoot = resolve(root, "dogfood/pm-001-project-memory/verification-frontier-6-fix-1");
...
for (const workItemId of workItemIds) {
  ...
  const executionDir = `dogfood/pm-001-project-memory/execution-frontier-6-fix-1/${workItemId}`;
...
const summary = { apiVersion: "devrelay.dev/v1alpha1", kind: "Pm001SixthFrontierFixOneVerificationSummary", results };

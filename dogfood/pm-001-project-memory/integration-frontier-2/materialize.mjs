...
const outRoot = resolve(root, "dogfood/pm-001-project-memory/integration-frontier-2");
mkdirSync(outRoot, { recursive: true });
const API = "devrelay.dev/v1alpha1";
const targetRef = "refs/heads/codex/pm-001-integration-frontier-2-r2";
const sourceRef = "refs/heads/codex/pm-001-source-frontier-2-r2";
...
const baseCommit = json("dogfood/pm-001-project-memory/integration-frontier-1/integration-summary.json").finalCommit;
...
try {
  ...
  for (const workItemId of ids) {
    const change = json(`dogfood/pm-001-project-memory/execution-frontier-2/${workItemId}/change-set-draft.json`);
...
const graphSummary = json("dogfood/pm-001-project-memory/execution-frontier-2/execution-summary.json");
let graphSnapshot = json("dogfood/pm-001-project-memory/execution-frontier-2/WI-PM-NATIVE-ENGINE/traceability-graph-snapshot.json");
...
for (const workItemId of ids) {
  ...
  const verificationDir = `dogfood/pm-001-project-memory/verification-frontier-2/${workItemId}`;
  ...
  const verifiedChange = json(`dogfood/pm-001-project-memory/execution-frontier-2/${workItemId}/change-set-draft.json`);

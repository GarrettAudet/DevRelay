...
const integrationSummary = readJson(
  "dogfood/pm-001-project-memory/integration-frontier-4/integration-summary.json",
);
...
const completionsValue = readJson(
  "dogfood/pm-001-project-memory/frontier-5/integrated-completion-fact-set.json",
);
const completions = canonicalLoaded(
  completionsValue,
  "ICFS-PM-001-FRONTIER-5",
...
const jobs = [
  { workItemId: "WI-PM-DESKTOP-INTEGRATION", attemptId: "ATT-PM-DESKTOP-INTEGRATION-001", files: ["src/public-facade.mjs", "src/root.mjs", "src/index.mjs", "src/api-tiers.mjs", "test/public-facade.test.mjs", "test/api-tiers.test.mjs", "docs/project-memory.md", "README.md"], command: "node --test test/api-tiers.test.mjs test/public-facade.test.mjs test/project-memory-conclude.test.mjs test/project-memory-context.test.mjs test/mem0-project-memory-adapter.test.mjs test/project-memory-traceability.test.mjs test/project-memory.test.mjs test/project-memory-artifacts.test.mjs", tests: 53 },
];
const permissions = [
...
const graphHeadPath =
  "dogfood/pm-001-project-memory/integration-frontier-4/WI-PM-CONCLUDE-GATE/traceability-graph-snapshot.json";
...
const summary = {
  apiVersion: API,
  kind: "Pm001FrontierFiveExecutionSummary",

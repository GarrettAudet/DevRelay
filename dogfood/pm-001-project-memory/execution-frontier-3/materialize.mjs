...
const integrationSummary = readJson(
  "dogfood/pm-001-project-memory/integration-frontier-2/integration-summary.json",
);
...
const completionsValue = readJson(
  "dogfood/pm-001-project-memory/frontier-3/integrated-completion-fact-set.json",
);
const completions = canonicalLoaded(
  completionsValue,
  "ICFS-PM-001-FRONTIER-3",
...
const jobs = [
  { workItemId: "WI-PM-CONTEXT-BOOTSTRAP", attemptId: "ATT-PM-CONTEXT-BOOTSTRAP-001", files: ["src/project-memory-context.mjs", "test/project-memory-context.test.mjs"], command: "node --test test/project-memory-context.test.mjs", tests: 5 },
  { workItemId: "WI-PM-MEM0-ADAPTER", attemptId: "ATT-PM-MEM0-ADAPTER-001", files: ["src/mem0-project-memory-adapter.mjs", "test/mem0-project-memory-adapter.test.mjs"], command: "node --test test/mem0-project-memory-adapter.test.mjs", tests: 3 },
  { workItemId: "WI-PM-TRACEABILITY", attemptId: "ATT-PM-TRACEABILITY-001", files: ["src/project-memory-traceability.mjs", "test/project-memory-traceability.test.mjs"], command: "node --test test/project-memory-traceability.test.mjs", tests: 3 },
];
const permissions = [
...
const graphHeadPath =
  "dogfood/pm-001-project-memory/integration-frontier-2/WI-PM-NATIVE-ENGINE/traceability-graph-snapshot.json";
...
const summary = {
  apiVersion: API,
  kind: "Pm001FrontierThreeExecutionSummary",
...
for (const job of jobs) {
  ...
  const moduleInvocation = {
    ...
    invocationId: `WE-PM-001-${item.id}`,
    module: {
      id: "work-execution",
      version: "0.1.0",

...
const firstFacts = [
  readJson("dogfood/pm-001-project-memory/frontier-2/COMPLETION-WI-PM-ARTIFACT-CONTRACTS-001.json"),
];
const execution = readJson("dogfood/pm-001-project-memory/execution-frontier-2/execution-summary.json");
const verification = readJson("dogfood/pm-001-project-memory/verification-frontier-2/verification-summary.json");
const integration = readJson("dogfood/pm-001-project-memory/integration-frontier-2/integration-summary.json");
const integratedRefs = new Map([
  ["WI-PM-NATIVE-ENGINE", integration.results[0].integratedChange],
]);
...
const readyFrontier = deriveReadyFrontier({ baseline, completionFacts, frontierId: "FRONTIER-PM-001-003" });

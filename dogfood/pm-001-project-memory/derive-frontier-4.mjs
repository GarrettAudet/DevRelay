...
const firstFacts = [
  readJson("dogfood/pm-001-project-memory/frontier-3/COMPLETION-WI-PM-ARTIFACT-CONTRACTS-001.json"),
  readJson("dogfood/pm-001-project-memory/frontier-3/COMPLETION-WI-PM-NATIVE-ENGINE-001.json"),
];
const execution = readJson("dogfood/pm-001-project-memory/execution-frontier-3/execution-summary.json");
const verification = readJson("dogfood/pm-001-project-memory/verification-frontier-3/verification-summary.json");
const integration = readJson("dogfood/pm-001-project-memory/integration-frontier-3/integration-summary.json");
...
const readyFrontier = deriveReadyFrontier({ baseline, completionFacts, frontierId: "FRONTIER-PM-001-004" });

...
const jobs = [
  {
    ...
    attemptId: "ATT-PM-REGRESSION-PERFORMANCE-002",
...
const graphHeadPath =
  "dogfood/pm-001-project-memory/integration-frontier-6/WI-PM-REGRESSION-PERFORMANCE/traceability-graph-snapshot.json";
...
const summary = {
  apiVersion: API,
  kind: "Pm001FrontierSixFixOneExecutionSummary",

...
const integrationSummary = readJson(
  "dogfood/pm-001-project-memory/integration-frontier-3/integration-summary.json",
);
...
const completionsValue = readJson(
  "dogfood/pm-001-project-memory/frontier-4/integrated-completion-fact-set.json",
);
const completions = canonicalLoaded(
  completionsValue,
  "ICFS-PM-001-FRONTIER-4",
...
const jobs = [
  { workItemId: "WI-PM-CONCLUDE-GATE", attemptId: "ATT-PM-CONCLUDE-GATE-001", files: ["src/project-memory-conclude.mjs", "test/project-memory-conclude.test.mjs"], command: "node --test test/project-memory-conclude.test.mjs", tests: 5 },
];
const permissions = [
...
const graphHeadPath =
  "dogfood/pm-001-project-memory/integration-frontier-3/WI-PM-TRACEABILITY/traceability-graph-snapshot.json";
...
const summary = {
  apiVersion: API,
  kind: "Pm001FrontierFourExecutionSummary",

# Treat module memory as invocation-scoped retrieval rather than durable agents
...
- OPT-PM-INVOCATION-SCOPE
- OPT-PM-PER-MODULE-AGENT

## Decision Outcome

Chosen option: "OPT-PM-INVOCATION-SCOPE", because it preserves the approved authority boundary. The selected boundary preserves Core-owned routing, closure, validation, checkpointing, traceability, and Gate authority while allowing bounded best-in-class capabilities to be swapped.

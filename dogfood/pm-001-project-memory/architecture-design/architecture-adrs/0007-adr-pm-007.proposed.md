# Use DevRelay-managed conclusion and recovery instead of an undocumented tab-close hook
...
- OPT-PM-MANAGED-CONCLUDE
- OPT-PM-TAB-CLOSE-HOOK

## Decision Outcome

Chosen option: "OPT-PM-MANAGED-CONCLUDE", because it preserves the approved authority boundary. The selected boundary preserves Core-owned routing, closure, validation, checkpointing, traceability, and Gate authority while allowing bounded best-in-class capabilities to be swapped.

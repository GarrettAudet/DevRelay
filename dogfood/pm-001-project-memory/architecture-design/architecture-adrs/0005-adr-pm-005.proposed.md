# Project TraceabilityGraph through trusted Core services
...
- OPT-PM-TRUSTED-PROJECTION
- OPT-PM-PROVIDER-GRAPH-ACCESS

## Decision Outcome

Chosen option: "OPT-PM-TRUSTED-PROJECTION", because it preserves the approved authority boundary. The selected boundary preserves Core-owned routing, closure, validation, checkpointing, traceability, and Gate authority while allowing bounded best-in-class capabilities to be swapped.

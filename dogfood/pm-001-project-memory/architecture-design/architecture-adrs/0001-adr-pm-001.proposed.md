# Keep ProjectMemoryBaseline authoritative and all provider state derived
...
- OPT-PM-CANONICAL-BASELINE
- OPT-PM-PROVIDER-AUTHORITY

## Decision Outcome

Chosen option: "OPT-PM-CANONICAL-BASELINE", because it preserves the approved authority boundary. The selected boundary preserves Core-owned routing, closure, validation, checkpointing, traceability, and Gate authority while allowing bounded best-in-class capabilities to be swapped.

...
export async function promoteProjectMemoryArchitecture(context) {
  const {
    root,
    dir,
    read,
  ...
  const ownerApprovalBytes = read(
    "dogfood/pm-001-project-memory/architecture-design/architecture-gate-owner-approval.json",
  );
  ...
  const gateReviewRef = fileRef(
    "architecture-gate-review-pm-001-project-memory-v1",
  ...
  const executionProofRef = fileRef(
    "architecture-dogfood-execution-proof-pm-001-project-memory-v1",
  ...
  const promotedBaseline = {
    ...
    baselineId: "architecture-baseline-devrelay-v1-pm-001-project-memory-001",
  ...
  const promotedProjectState = {
    ...
    stateId: "project-architecture-state-devrelay-pm-001-project-memory-approved-v1",
    state: "baselined",
  ...
  const expectedRequiredInterfaces = [
    ...new Set([
      ...
      "IF-PM-CONCLUDE",
      "IF-PM-SYNOPSIS",
      "IF-PM-TRACE-PROJECTION",
      "IF-PM-TRACE-CONTRIBUTION",
    ]),
  ].sort();
  if (
  ...
  const promotionId = "architecture-promotion-pm-001-project-memory-v1";

# Require explicit qualitative delta disposition at conclusion
...
- OPT-PM-EXACT-DISPOSITION
- OPT-PM-AUTO-QUALITATIVE

## Decision Outcome

Chosen option: "OPT-PM-EXACT-DISPOSITION", because it preserves the approved authority boundary. The selected boundary preserves Core-owned routing, closure, validation, checkpointing, traceability, and Gate authority while allowing bounded best-in-class capabilities to be swapped.

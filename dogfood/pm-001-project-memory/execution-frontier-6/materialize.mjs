...
const integrationSummary = readJson(
  "dogfood/pm-001-project-memory/integration-frontier-5/integration-summary.json",
);
...
const completionsValue = readJson(
  "dogfood/pm-001-project-memory/frontier-6/integrated-completion-fact-set.json",
);
const completions = canonicalLoaded(
  completionsValue,
  "ICFS-PM-001-FRONTIER-6",
...
const jobs = [
  {
    workItemId: "WI-PM-REGRESSION-PERFORMANCE",
    attemptId: "ATT-PM-REGRESSION-PERFORMANCE-001",
    files: [
      "README.md",
      "RELEASE.md",
      "docs/version-policy.md",
      "examples/modules/project-memory.module.json",
      "examples/plugins/mem0-project-memory.plugin.json",
      "package.json",
      "scripts/release-catalog.mjs",
      "src/change-integration-local-git-adapter.mjs",
      "src/project-memory-context.mjs",
      "src/project-memory.mjs",
      "test/change-integration-local-git-adapter.test.mjs",
      "test/project-baseline.test.mjs",
      "test/project-memory-context.test.mjs",
      "test/project-memory-module.test.mjs",
      "test/project-memory-performance.test.mjs",
      "test/project-memory.test.mjs",
    ],
    command: "npm.cmd run verify && npm.cmd run release:check",
    tests: 1037,
  },
];
const permissions = [
...
const graphHeadPath =
  "dogfood/pm-001-project-memory/integration-frontier-5/WI-PM-DESKTOP-INTEGRATION/traceability-graph-snapshot.json";
...
const summary = {
  apiVersion: API,
  kind: "Pm001FrontierSixExecutionSummary",

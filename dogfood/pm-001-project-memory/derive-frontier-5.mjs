...
const firstFacts = [
  readJson("dogfood/pm-001-project-memory/frontier-4/COMPLETION-WI-PM-ARTIFACT-CONTRACTS-001.json"),
  readJson("dogfood/pm-001-project-memory/frontier-4/COMPLETION-WI-PM-CONTEXT-BOOTSTRAP-001.json"),
  readJson("dogfood/pm-001-project-memory/frontier-4/COMPLETION-WI-PM-MEM0-ADAPTER-001.json"),
  readJson("dogfood/pm-001-project-memory/frontier-4/COMPLETION-WI-PM-NATIVE-ENGINE-001.json"),
  readJson("dogfood/pm-001-project-memory/frontier-4/COMPLETION-WI-PM-TRACEABILITY-001.json"),
];
const execution = readJson("dogfood/pm-001-project-memory/execution-frontier-4/execution-summary.json");
const verification = readJson("dogfood/pm-001-project-memory/verification-frontier-4/verification-summary.json");
const integration = readJson("dogfood/pm-001-project-memory/integration-frontier-4/integration-summary.json");
...
const readyFrontier = deriveReadyFrontier({ baseline, completionFacts, frontierId: "FRONTIER-PM-001-005" });

...
const jobs = [
  {
    ...
    attemptId: "ATT-PM-WINDOWS-E2E-003",
    files: [
    ...
    command: "node --test test/package-export-verification.test.mjs",
    tests: 4,
  },
];
const permissions = [
  { kind: "filesystem.write", scope: { values: ["dogfood/pm-001-project-memory/system-verification-attempt-2/**", "scripts/**"] } },
  { kind: "process.spawn", scope: { values: ["node"] } },
];

const graphHeadPath =
  "dogfood/pm-001-project-memory/integration-frontier-7-fix-1/WI-PM-WINDOWS-E2E/traceability-graph-snapshot.json";
...
const summary = {
  apiVersion: API,
  kind: "Pm001FrontierSevenFixTwoExecutionSummary",

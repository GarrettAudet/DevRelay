...
const execution = readJson(
  "dogfood/pm-001-project-memory/execution-frontier-1/execution-summary.json",
);
const verification = readJson(
  "dogfood/pm-001-project-memory/verification-frontier-1/verification-summary.json",
);
...
const readyFrontier = deriveReadyFrontier({
  baseline,
  completionFacts,
  frontierId: "FRONTIER-PM-001-002",
});

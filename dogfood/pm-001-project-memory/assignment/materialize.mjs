...
async function write(name, value) {
  ...
  return {
    ...
    ref: {
      ...
      uri: `devrelay-repo:///dogfood/pm-001-project-memory/assignment/${name}`,
    },
  };
}
...
const repositoryContext = await read("dogfood/pm-001-project-memory/repository-snapshot.json");
...
const gateCandidate = {
  ...
  gateCandidateId: "SA-GATE-CANDIDATE-PM-001-001",
...
const approval = {
  ...
  approvalId: "SA-GATE-APPROVAL-PM-001-001",
  decision: "approve",
...
const approvalRef = {
  ...
  uri: "devrelay-repo:///dogfood/pm-001-project-memory/assignment/specialist-assignment-gate-owner-approval.json",
};
...
const proof = {
  ...
  proofId: "SA-DOGFOOD-PROOF-PM-001-001",
...
await write("a2a-agent-card-snapshot-set.json", {
  ...
  snapshotSetId: "A2A-SNAPSHOT-SET-PM-001-001",

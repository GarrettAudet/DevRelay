...
const firstFacts = [
  readJson("dogfood/pm-001-project-memory/frontier-6/COMPLETION-WI-PM-ARTIFACT-CONTRACTS-001.json"),
  readJson("dogfood/pm-001-project-memory/frontier-6/COMPLETION-WI-PM-CONCLUDE-GATE-001.json"),
  readJson("dogfood/pm-001-project-memory/frontier-6/COMPLETION-WI-PM-CONTEXT-BOOTSTRAP-001.json"),
  readJson("dogfood/pm-001-project-memory/frontier-6/COMPLETION-WI-PM-DESKTOP-INTEGRATION-001.json"),
  readJson("dogfood/pm-001-project-memory/frontier-6/COMPLETION-WI-PM-MEM0-ADAPTER-001.json"),
  readJson("dogfood/pm-001-project-memory/frontier-6/COMPLETION-WI-PM-NATIVE-ENGINE-001.json"),
  readJson("dogfood/pm-001-project-memory/frontier-6/COMPLETION-WI-PM-TRACEABILITY-001.json"),
];
const execution = readJson("dogfood/pm-001-project-memory/execution-frontier-6-fix-2/execution-summary.json");
const verification = readJson("dogfood/pm-001-project-memory/verification-frontier-6-fix-2/verification-summary.json");
const integration = readJson("dogfood/pm-001-project-memory/integration-frontier-6-fix-2/integration-summary.json");
...
const readyFrontier = deriveReadyFrontier({ baseline, completionFacts, frontierId: "FRONTIER-PM-001-007" });

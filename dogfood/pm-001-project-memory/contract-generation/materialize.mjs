...
const RUN_ID = "pm-001-project-memory-contract-change-run-v1";
const INVOCATION_ID = "contract-generation-change-pm-001-project-memory-v1";
const GRAPH_ID = "devrelay/pm-001-project-memory-contract-change";
...
const state = await exactJsonFile(
  "project-contract-state.json",
  {
    ...
    stateId: "PCS-DEVRELAY-CONTRACTS-PM-001-001",
    state: "baselined",
  ...
  "PCS-DEVRELAY-CONTRACTS-PM-001-001",
);
...
const executionRecordFile = await exactJsonFile(
  ...
  "MER-CONTRACT-CHANGE-PM-001-001",
);
...
const gateReview = await exactJsonFile(
  "contract-gate-review.json",
  {
    ...
    reviewId: "CGR-PM-001-CONTRACT-CHANGE-001",
...
const gateCandidate = await exactJsonFile(
  "contract-gate-candidate.json",
  {
    ...
    gateCandidateId: "CGC-PM-001-001",
    candidate: execution.candidateRef,
    architectureBaseline: architecture.ref,
    projectOverviewBaseline: projectOverview.ref,

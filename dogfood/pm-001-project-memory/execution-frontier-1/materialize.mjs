...
const jobs = [
  {
    workItemId: "WI-PM-ARTIFACT-CONTRACTS",
    attemptId: "ATT-PM-ARTIFACT-CONTRACTS-001",
    files: [
      "contracts/project-memory-artifacts.schema.json",
      "src/project-memory-artifact-validator.mjs",
      "test/project-memory-artifacts.test.mjs",
    ],
    command: "node --test test/project-memory-artifacts.test.mjs",
    tests: 12,
  },
];const permissions = [
...
const graphHeadPath =
  "dogfood/pm-001-project-memory/assignment/promotion/traceability-graph-snapshot.json";
...
const summary = {
  apiVersion: API,
  kind: "Pm001FrontierOneExecutionSummary",

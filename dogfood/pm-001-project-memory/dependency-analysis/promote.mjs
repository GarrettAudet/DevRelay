...
const APPROVED = Object.freeze({
  candidate: "sha256:6a3b836a675e4378802e41c2f4caad9386534ebf27c3b44b8a14dc2ae51b14a5",
  gateReview: "sha256:8eff56842de2110ffb06a771acbed3261a564d2d703326e9ed14243cd57ad95d",
  gateCandidate: "sha256:0efcfbbcaf02bd5815fd01a22d133b033b7c810ef7bc1300c72d64519467df21",
  checkpoint: "sha256:cc7b667f412c5d836c0bb91ddb8c4f87277f41b47b59b1feca1e931566219a6a",
  checkpointRaw: "sha256:af80171a0a4d4e2a4996ac9a0b830dd0c6351906c48e8b326e8fd87a12a0eb75",
  repositorySnapshot: "sha256:544787b3fa91b8c7b38594b1d0c7effc9feb2b4494dd1f63b6a93d58c0efe903",
  repositoryRevision: "a18e6fbfac4f8e3088b349dd2c018efcc5dc0bc1",
  repositoryTree: "sha256:e449ee8152cfeb20b655784ab2227efdca71a97afbc334c0452a23e7572a1a08",
});
...
const candidate = await loadedJson(
  "dogfood/pm-001-project-memory/dependency-analysis/work-dependency-candidate.json",
  {
  ...
  "WDC-711D70B02B5FA48C",
);
const gateReview = await loadedJson(
  "dogfood/pm-001-project-memory/dependency-analysis/work-dependency-gate-review.json",
  CONTRACTS.gateReview,
  "WDA-GATE-REVIEW-PM-001-001",
);
const gateCandidate = await loadedJson(
  "dogfood/pm-001-project-memory/dependency-analysis/gate-candidate.json",
  CONTRACTS.gateCandidate,
  "WDA-GATE-CANDIDATE-PM-001-001",
);
const checkpoint = await loadedJson(
  "dogfood/pm-001-project-memory/dependency-analysis/execution-checkpoint.json",
  CONTRACTS.executionCheckpoint,
  "WDA-PM-001-001-CHECKPOINT",
);
...
const approvalValue = {
  ...
  approvalId: "WDA-GATE-OWNER-APPROVAL-PM-001-001",
...
const priorRecord = await loadedJson(
  "dogfood/pm-001-project-memory/work-breakdown/module-execution-record.json",
  CONTRACTS.executionRecord,
  "work-breakdown-decompose-pm-001-v1",
);
const priorGraphUrl = new URL(
  "dogfood/pm-001-project-memory/work-breakdown/traceability-graph-snapshot.json",
  ROOT,
);
...
const invocation = {
  ...
  invocationId: "work-dependency-gate-promote-pm-001-v1",
  runId: "work-dependency-gate-run-pm-001-v1",
  nodeId: "work-dependency-gate-node-pm-001-v1",
  module,
  inputs: {},
  options: {},
};
...
const promotionProofValue = {
  ...
  proofId: "WDA-GATE-PROMOTION-PM-001-001",
  status: "promoted",
  approval: approval.ref,
  gateCandidate: gateCandidate.ref,
...
const baselineHistory = new URL("project/history/work-dependency/WDB-RM-001-001/WDA-GATE-PROMOTION-RM-001-001/", ROOT);

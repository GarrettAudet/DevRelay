...
const REPOSITORY_REVISION = "0daf16c6582c603a25c34e97ca078f98676c8e3f";
...
const contextSliceSetValue = {
  ...
  sliceSetId: "CTXS-WDA-RM-001-001",
  slices: [
    createContextSlice({
      id: "CTX-WDA-RM-001-REQUIREMENTS",
    ...
    createContextSlice({
      id: "CTX-WDA-RM-001-ARCHITECTURE",
    ...
    createContextSlice({
      id: "CTX-WDA-RM-001-REPOSITORY-REVISION",
...
const gateReview = await exactJsonFile(
  "work-dependency-gate-review.json",
  {
    ...
    reviewId: "WDA-GATE-REVIEW-RM-001-001",
...
const gateCandidate = await exactJsonFile(
  "gate-candidate.json",
  {
    ...
    gateCandidateId: "WDA-GATE-CANDIDATE-RM-001-001",
    candidate: execution.candidateRef,
    workBreakdownBaseline: workBreakdown.ref,

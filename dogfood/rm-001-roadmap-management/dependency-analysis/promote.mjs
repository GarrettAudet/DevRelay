...
const APPROVED = Object.freeze({
  candidate: "sha256:5988880bd3bc4772d54d523ca60632faf99fc8af4749ca86d131ab7932bbda65",
  gateReview: "sha256:099e7bc1f2edc00a4ddc1cb236c88ae9caf051666ae20113a3db143fe68e1234",
  gateCandidate: "sha256:27cae1fca4ea3ed5fcdfa5b64efb53ce52d29cd80be2434234bf9ae162b13822",
  checkpoint: "sha256:1a629933daa4e826b1a1f6cad4ec4e403290b3a7c492ebd289e566a44da4c83a",
  checkpointRaw: "sha256:2c9e052472578900885682c2714a1c9c49b01be03cc66fbf3cdf12a3d125aa23",
  repositorySnapshot: "sha256:9ce13359c2c00cd2c84d852fea04c34b7f6b9f0f99c7da6b2c02edc114cbd7db",
  repositoryRevision: "0daf16c6582c603a25c34e97ca078f98676c8e3f",
  repositoryTree: "sha256:3ad20b859ffc177b1fcab398c5f14a54d92d7dd98a6ccb1e867b32c7d57e27f7",
});
...
const repositorySnapshot = await loadedJson(
  ...
  "repository-snapshot-devrelay-0daf16c",
);
...
const candidate = await loadedJson(
  "dogfood/rm-001-roadmap-management/dependency-analysis/work-dependency-candidate.json",
  {
  ...
  "WDC-1EFFF5F6F8D559E2",
);
const gateReview = await loadedJson(
  "dogfood/rm-001-roadmap-management/dependency-analysis/work-dependency-gate-review.json",
  CONTRACTS.gateReview,
  "WDA-GATE-REVIEW-RM-001-001",
);
const gateCandidate = await loadedJson(
  "dogfood/rm-001-roadmap-management/dependency-analysis/gate-candidate.json",
  CONTRACTS.gateCandidate,
  "WDA-GATE-CANDIDATE-RM-001-001",
);
const checkpoint = await loadedJson(
  "dogfood/rm-001-roadmap-management/dependency-analysis/execution-checkpoint.json",
  CONTRACTS.executionCheckpoint,
  "WDA-RM-001-001-CHECKPOINT",
);
...
const approvalValue = {
  ...
  approvalId: "WDA-GATE-OWNER-APPROVAL-RM-001-001",
...
const priorRecord = await loadedJson(
  "dogfood/rm-001-roadmap-management/work-breakdown/module-execution-record.json",
  CONTRACTS.executionRecord,
  "work-breakdown-decompose-rm-001-v1",
);
const priorGraphUrl = new URL(
  "dogfood/rm-001-roadmap-management/work-breakdown/traceability-graph-snapshot.json",
  ROOT,
);
...
const invocation = {
  ...
  invocationId: "work-dependency-gate-promote-rm-001-v1",
  runId: "work-dependency-gate-run-rm-001-v1",
  nodeId: "work-dependency-gate-node-rm-001-v1",
  module,
  inputs: {},
  options: {},
};
...
const promotionProofValue = {
  ...
  proofId: "WDA-GATE-PROMOTION-RM-001-001",
  status: "promoted",
  approval: approval.ref,
  gateCandidate: gateCandidate.ref,
...
const baselineHistory = new URL("project/history/work-dependency/WDB-SIM-001-001/WDA-GATE-PROMOTION-SIM-001-001/", ROOT);

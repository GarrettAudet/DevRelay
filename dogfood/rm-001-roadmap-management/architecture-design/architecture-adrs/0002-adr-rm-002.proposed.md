# Keep RoadmapGate promotion authority in Generic Core
...
- OPT-RM-CORE-GATE
- OPT-RM-ADAPTER-MUTATION

## Decision Outcome

Chosen option: "OPT-RM-CORE-GATE", because it preserves the approved authority boundary. The selected boundary preserves Core-owned routing, closure, validation, checkpointing, traceability, and Gate authority while allowing bounded best-in-class capabilities to be swapped.

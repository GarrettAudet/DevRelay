# Keep session context separate from explicit ModuleInvocation ports
...
- OPT-RM-ORIENTATION-ONLY
- OPT-RM-HIDDEN-INPUT-INJECTION

## Decision Outcome

Chosen option: "OPT-RM-ORIENTATION-ONLY", because it preserves the approved authority boundary. The selected boundary preserves Core-owned routing, closure, validation, checkpointing, traceability, and Gate authority while allowing bounded best-in-class capabilities to be swapped.

# Keep RoadmapManagement cross-cutting rather than a mandatory construction stage
...
- OPT-RM-CROSS-CUTTING
- OPT-RM-MANDATORY-STAGE

## Decision Outcome

Chosen option: "OPT-RM-CROSS-CUTTING", because it preserves the approved authority boundary. The selected boundary preserves Core-owned routing, closure, validation, checkpointing, traceability, and Gate authority while allowing bounded best-in-class capabilities to be swapped.

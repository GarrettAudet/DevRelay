# Use structured RoadmapBaseline with deterministic Markdown projection
...
- OPT-RM-STRUCTURED-BASELINE
- OPT-RM-MARKDOWN-AUTHORITY

## Decision Outcome

Chosen option: "OPT-RM-STRUCTURED-BASELINE", because it preserves the approved authority boundary. The selected boundary preserves Core-owned routing, closure, validation, checkpointing, traceability, and Gate authority while allowing bounded best-in-class capabilities to be swapped.

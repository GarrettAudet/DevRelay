# Use native file contracts as authority with optional proposer adapters
...
- OPT-RM-NATIVE-AUTHORITY
- OPT-RM-EXTERNAL-SYSTEM-AUTHORITY

## Decision Outcome

Chosen option: "OPT-RM-NATIVE-AUTHORITY", because it preserves the approved authority boundary. The selected boundary preserves Core-owned routing, closure, validation, checkpointing, traceability, and Gate authority while allowing bounded best-in-class capabilities to be swapped.

# Require digest-bound session bootstrap for every fresh configured DevRelay task
...
- OPT-RM-MANDATORY-BOOTSTRAP
- OPT-RM-CONVERSATIONAL-MEMORY

## Decision Outcome

Chosen option: "OPT-RM-MANDATORY-BOOTSTRAP", because it preserves the approved authority boundary. The selected boundary preserves Core-owned routing, closure, validation, checkpointing, traceability, and Gate authority while allowing bounded best-in-class capabilities to be swapped.

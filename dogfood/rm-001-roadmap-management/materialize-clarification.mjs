...
import {
  ...
  projectContext,
  questions,
} from "./rm-001-roadmap-management-clarification-data.mjs";
...
const invocation = Object.freeze({
  ...
  invocationId:
    "invocation-requirements-rm-001-roadmap-management-openspec-clarify-v1",
  runId: "dogfood-rm-001-roadmap-management-v1",
      ...
      adapter: {
        async invoke(_adapterInvocation, _adapterContext, producer) {
          ...
          const clarificationRequest = {
            ...
            requestSetId: "clarification-request-rm-001-roadmap-management-v1",
            baseInputs,
            questions,
          };
          ...
          continuation = {
            ...
            continuationId: "requirements-continuation-rm-001-roadmap-management-v1",
            ...
            confirmedFacts: [
              ...
              "The owner identified human-controlled roadmap intake, deterministic prioritization, and mandatory fresh-task context as RM-001 priorities.",
              "No promotable RM-001 RoadmapManagement requirements change exists until every blocking question is answered and deterministic closure is proven.",
            ],
...
const executionProof = {
  ...
  proofId: "requirements-clarification-rm-001-roadmap-management-v1",
...
const transcript =
  "# RM-001 RoadmapManagement RequirementsGathering clarification\n\n" +
  "Status: `needs_clarification`\n\n" +
  "RequirementsGathering executed as a change against the exact approved DevRelay requirements and ProjectOverview baselines through the bounded `openspec@0.1.0` contract. No OpenSpec CLI execution is claimed, no promotable change candidate exists, and RM-001 RoadmapManagement design and implementation are blocked until every question below is answered.\n\n" +
  questions
    .map(
      (question, index) =>
  ...
  writeFile(
    ...
    Buffer.from(
      "# RM-001 RoadmapManagement dogfood\n\n" +
        "Current state: RequirementsGathering is checkpointed at `needs_clarification`. The exact request, continuation, approved baseline inputs, and effect checkpoint form the resumable package. No RM-001 RoadmapManagement requirements change, architecture candidate, work breakdown, or implementation is authorized.\n",
    ),
  ),
]);

...
const RUN_ID = "rm-001-roadmap-management-contract-change-run-v1";
const INVOCATION_ID = "contract-generation-change-rm-001-roadmap-management-v1";
const GRAPH_ID = "devrelay/rm-001-roadmap-management-contract-change";
...
const state = await exactJsonFile(
  "project-contract-state.json",
  {
    ...
    stateId: "PCS-DEVRELAY-CONTRACTS-RM-001-001",
    state: "baselined",
  ...
  "PCS-DEVRELAY-CONTRACTS-RM-001-001",
);
...
const executionRecordFile = await exactJsonFile(
  ...
  "MER-CONTRACT-CHANGE-RM-001-001",
);
...
const gateReview = await exactJsonFile(
  "contract-gate-review.json",
  {
    ...
    reviewId: "CGR-RM-001-CONTRACT-CHANGE-001",
...
const gateCandidate = await exactJsonFile(
  "contract-gate-candidate.json",
  {
    ...
    gateCandidateId: "CGC-RM-001-001",
    candidate: execution.candidateRef,
    architectureBaseline: architecture.ref,
    projectOverviewBaseline: projectOverview.ref,

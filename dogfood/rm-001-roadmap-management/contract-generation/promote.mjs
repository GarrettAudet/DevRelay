...
const DISPLACED_CONTEXT = new URL("history/pre-rm-001-contract-promotion/", WORK_BREAKDOWN_CONTEXT);
const APPROVED = Object.freeze({
  candidate: "sha256:096a1fb3a868d512ab0aa42387d8e0980458f545b8f08f58d3905fbdd3e2895b",
  gateReview: "sha256:ab75657e2f05b78901e350ef49a511bad2becd379d0a918fbbbe61663e3d3c00",
  gateCandidate: "sha256:3b7b5120e0aba8a0df93c74c619e1b9766d815b4c4997283351e602686ea4acf",
  checkpoint: "sha256:53ff9fe178773768623e1d06f8495f9cdf721c55c36c9bdd2f91e641246308a6",
  traceabilityUpdate: "sha256:7509a45f1071b3084670d44940cec679500550f069e6ed7692b17c7b706b79a1",
  executionRecord: "sha256:2401307d3036db4ea4f71efc69d9233dcc688c0154f979b8c009a5b83e7a6117",
});
...
const approvalValue = {
  ...
  approvalId: "CGA-RM-001-CONTRACT-CHANGE-001",
...
const stateValue = {
  ...
  stateId: "PCS-DEVRELAY-CONTRACTS-RM-001-BASELINED-001",
  state: "baselined",
  architectureBaseline: dogfood.architecture.ref,
  projectOverviewBaseline: dogfood.projectOverview.ref,
...
const upstreamGraph = createTraceabilityGraphService({
  graphId: "devrelay/rm-001-contract-generation-promotion",
  projectId: "devrelay",
  store: graphStore,
  contributors: [
...
const gateInvocation = {
  invocationId: "contract-gate-promotion-rm-001-v1",
...
const promotionValue = {
  ...
  promotionId: "CGP-RM-001-CONTRACT-CHANGE-001",
  candidate: dogfood.candidateLoaded.ref,
...
await preserveAndReplaceCurrent(
  ...
  new URL("project/history/contracts/CB-DEVRELAY-011/contract-baseline.json", ROOT),
);
await preserveAndReplaceCurrent(
  disposition,
  new URL("project/contract-disposition.json", ROOT),
  new URL("project/history/contracts/CB-DEVRELAY-011/contract-disposition.json", ROOT),
);
await preserveAndReplaceCurrent(
  promotion,
  new URL("project/contract-gate-promotion.json", ROOT),
  new URL("project/history/contracts/CB-DEVRELAY-011/contract-gate-promotion.json", ROOT),
);
await preserveAndReplaceCurrent(
  state,
  new URL("project/project-contract-state.json", ROOT),
  new URL("project/history/contracts/CB-DEVRELAY-011/project-contract-state.pre-rm-001.json", ROOT),
);

...
import {
  buildRoadmapRequirements,
  ownerDecisions,
} from "./rm-001-roadmap-management-approved-data.mjs";
...
const canonicalArtifactRoot =
  "file:///C:/repos/DevRelay/dogfood/rm-001-roadmap-management";
...
const goalDocument = await loadExisting({
  path: "dogfood/rm-001-roadmap-management/goal.json",
  artifactId: "goal-devrelay-rm-001-roadmap-management-v1",
  type: "goal",
  uri: `${canonicalArtifactRoot}/goal.json`,
});
const projectContextDocument = await loadExisting({
  path: "dogfood/rm-001-roadmap-management/project-context.json",
  artifactId: "project-context-devrelay-rm-001-roadmap-management-v1",
  type: "projectContext",
  uri: `${canonicalArtifactRoot}/project-context.json`,
});
const repositorySnapshotDocument = await loadExisting({
  path: "dogfood/rm-001-roadmap-management/repository-snapshot.json",
  artifactId: "repository-snapshot-devrelay-0daf16c",
  type: "repositorySnapshot",
  uri: `${canonicalArtifactRoot}/repository-snapshot.json`,
});
const clarificationRequestDocument = await loadExisting({
  path: "dogfood/rm-001-roadmap-management/clarification-request.json",
  artifactId: "clarification-request-rm-001-roadmap-management-v1",
  type: "clarificationRequest",
  uri: `${canonicalArtifactRoot}/clarification-request.json`,
});
const continuationDocument = await loadExisting({
  path: "dogfood/rm-001-roadmap-management/requirements-continuation.json",
  artifactId: "requirements-continuation-rm-001-roadmap-management-v1",
  type: "continuation",
...
const clarificationResponseRef = store.addJson(
  ...
  "clarification-response-rm-001-roadmap-management-v1",
  "clarificationResponse",
  clarificationResponse,
);
...
const replacement = buildRoadmapRequirements(
...
const requirementsChangeSet = {
  ...
  changeSetId: "requirements-change-set-rm-001-roadmap-management-v1",
...
const candidateMarkdownRef = store.addBytes(
  ...
  "project-overview-markdown-rm-001-roadmap-management-v1",
  "projectOverviewMarkdown",
...
const overviewChangeSet = {
  ...
  changeSetId: "project-overview-change-set-rm-001-roadmap-management-v1",
...
const nativeSourceBundle = {
  ...
  sources: [
    {
      role: "owner-decision",
      path: "dogfood/rm-001-roadmap-management/owner-decisions.md",
      artifact: pointer(ownerDecisionRef),
    },
    {
      role: "proposal",
      path: "dogfood/rm-001-roadmap-management/native/openspec/proposal.md",
      artifact: pointer(proposalRef),
    },
    {
      role: "specification",
      path: "dogfood/rm-001-roadmap-management/native/openspec/specs/rm-001-roadmap-management/spec.md",
...
const nativeSourceBundleRef = store.addJson(
  ...
  "native-source-bundle-rm-001-roadmap-management-v1",
  "nativeSourceBundle",
  nativeSourceBundle,
);
...
const invocation = {
  ...
  invocationId:
    "invocation-requirements-rm-001-roadmap-management-openspec-resume-v1",
  runId: "dogfood-rm-001-roadmap-management-v1-resume",
  ...
  config: {
    ...
    changeName: "rm-001-roadmap-management-module-v1",
    schema: "devrelay-requirements",
...
const sourceCheckpointDocument = JSON.parse(
  await readFile(
    new URL(
      "dogfood/rm-001-roadmap-management/requirements-gathering.checkpoint.json",
      root,
    ),
    "utf8",
  ),
...
const executionProof = {
  ...
  proofId: "requirements-change-rm-001-roadmap-management-v1",
...
const closureAssessmentBytes = await readFile(new URL("docs/specs/rm-001-roadmap-management/requirements-closure-assessment.json", root));
...
const gateReview = [
  "# Requirements Gate candidate: DevRelay RM-001 RoadmapManagement",
  "",
  ...
  "- PASS: the candidate preserves existing requirement identities and adds only the approved RM-001 RoadmapManagement scope.",

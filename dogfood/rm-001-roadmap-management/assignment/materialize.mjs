...
async function write(name, value) {
  ...
  return {
    ...
    ref: {
      ...
      uri: `devrelay-repo:///dogfood/rm-001-roadmap-management/assignment/${name}`,
    },
  };
}
...
const repositoryContext = await read("dogfood/rm-001-roadmap-management/repository-snapshot.json");
...
function a2aProfile({ slug, name, description, capabilityIds, toolIds, grantIds }) {
  ...
  const snapshot = {
    source: {
      ...
      uri: `fixture://devrelay/a2a/rm-001/${slug}.json`,
    },
    agentCard: card,
    toolIds,
    grantIds,
...
const assignmentPolicy = {
  ...
  policyId: "AP-RM-001-001",
  version: "2.0.0",
  workItemRules: [{
    workItemId: "WI-RM-WINDOWS-E2E",
...
const gateCandidate = {
  ...
  gateCandidateId: "SA-GATE-CANDIDATE-RM-001-001",
...
const approval = {
  ...
  approvalId: "SA-GATE-APPROVAL-RM-001-001",
  decision: "approve",
...
const approvalRef = {
  ...
  uri: "devrelay-repo:///dogfood/rm-001-roadmap-management/assignment/specialist-assignment-gate-owner-approval.json",
};
...
const proof = {
  ...
  proofId: "SA-DOGFOOD-PROOF-RM-001-001",
...
await write("a2a-agent-card-snapshot-set.json", {
  ...
  snapshotSetId: "A2A-SNAPSHOT-SET-RM-001-001",

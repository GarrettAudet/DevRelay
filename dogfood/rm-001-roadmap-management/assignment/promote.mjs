...
const historicalUpdateSourcePaths = [
  ...
  "../../v0.11-module-quality/work-breakdown/traceability-update.json",
  "../../v0.10-release-hardening/work-breakdown/traceability-update.json",
  ...
  "../../sim-001-simplification/work-breakdown/traceability-update.json",
  "../work-breakdown/traceability-update.json",
  "../dependency-analysis/promotion/traceability-update.json",
];
...
const draft = loaded(
  ...
  draftValue.draftId,
  "devrelay-repo:///dogfood/rm-001-roadmap-management/assignment/specialist-assignment-draft.json",
);
const candidate = await merge({
  invocation: {
    invocationId: "SA-RM-001-001",
    module: {
...
const approved = await merge({
  invocation: {
    invocationId: "SA-GATE-RM-001-001",
    module: {

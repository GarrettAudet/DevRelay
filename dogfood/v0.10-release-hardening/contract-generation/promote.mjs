...
const DISPLACED_CONTEXT = new URL("history/pre-replay-v1/", WORK_BREAKDOWN_CONTEXT);
const APPROVED = Object.freeze({
  candidate: "sha256:32edcf96f072b545a49a978e68ebe105450fa063772831e79f8b0dff996c306d",
  gateReview: "sha256:e5656971f395dfbfc0000227f4eec244feefcaa54a6db0bc0a6812c9c30d2a93",
  gateCandidate: "sha256:555b52c3dca9077bb7f23970847f662e7baf8c017d6be942c9d38b6e37fdd13b",
  checkpoint: "sha256:d3da00297daecc8fd18807850173726dd72ce29147dfefeb1cb62d41585d15d5",
  traceabilityUpdate: "sha256:5b979e866e52dc746f13e0268ff3c3c594f0da0e79a53fd0e07887e7457d1b0e",
  executionRecord: "sha256:2a9378cf56b3deabc3f75575cf0fa66f1f371b1377fabf6cce90df8aca139a89",
});
...
const approvalValue = {
  ...
  approvalId: "CGA-V010-RELEASE-HARDENING-CONTRACT-CHANGE-001",
...
const stateValue = {
  ...
  stateId: "PCS-DEVRELAY-CONTRACTS-V010-RELEASE-HARDENING-BASELINED-001",
  state: "baselined",
  architectureBaseline: dogfood.architecture.ref,
  projectOverviewBaseline: dogfood.projectOverview.ref,
...
const gateInvocation = {
  invocationId: "contract-gate-promotion-v0.10-release-hardening-v1",
...
const promotionValue = {
  ...
  promotionId: "CGP-V010-RELEASE-HARDENING-CONTRACT-CHANGE-001",
  candidate: dogfood.candidateLoaded.ref,
...
await preserveAndReplaceCurrent(
  ...
  new URL("project/history/contracts/CB-DEVRELAY-007/contract-baseline.json", ROOT),
);
await preserveAndReplaceCurrent(
  disposition,
  new URL("project/contract-disposition.json", ROOT),
  new URL("project/history/contracts/CB-DEVRELAY-007/contract-disposition.json", ROOT),
);
await preserveAndReplaceCurrent(
  promotion,
  new URL("project/contract-gate-promotion.json", ROOT),
  new URL("project/history/contracts/CB-DEVRELAY-007/contract-gate-promotion.json", ROOT),
);

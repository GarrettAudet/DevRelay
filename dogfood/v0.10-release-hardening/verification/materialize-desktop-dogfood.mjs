...
const jobs = [{
  ...
  reportId: "TEST-REL-DESKTOP-DOGFOOD-001",
  command: "Independent installed-package ChatGPT Desktop Windows lifecycle, exact replay, and application test suite",
  tests: 4,
  checkedFiles: collectFiles("dogfood/v0.10-release-hardening/desktop-dogfood"),
}];
const summary = {
  apiVersion: API,
...
writeJson("desktop-dogfood-verification-summary.json", summary);

# Use Windows as the release-defining compatibility host
...
- OPT-REL-WINDOWS-RELEASE-DEFINING
- OPT-REL-GENERIC-CI-IMPLIES-WINDOWS

## Decision outcome

Chosen: OPT-REL-WINDOWS-RELEASE-DEFINING. The selected boundary keeps package exports canonical, separates evidence from host-enforced GitHub effects, and preserves DevRelay Gate authority.

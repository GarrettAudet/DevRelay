workspace "DevRelay Release Hardening" "GitHub-only Windows source/library release architecture" {
  !identifiers flat
  ...
  model {
    ...
    e2 -> e96 "Supplies exact approved lifecycle, source, and acceptance identities without delegating Gate authority." {
      properties {
        "devrelay.id" "REL-CORE-RELEASE-TOOLING"
      }
    }
    e97 -> e98 "Supplies the canonical expanded public export inventory." {
      properties {
        "devrelay.id" "REL-REL-EXPORT-TARBALL"
      }
    }
    e98 -> e99 "Supplies the exact candidate tarball for isolated installation." {
      properties {
        "devrelay.id" "REL-REL-TARBALL-VERIFY"
      }
    }
    e99 -> e100 "Supplies exact Windows and Node installed-consumer results." {
      properties {
        "devrelay.id" "REL-REL-VERIFY-EVIDENCE"
      }
    }
    e100 -> e101 "Supplies the exact accepted release evidence and exclusions." {
      properties {

...
const headPath =
  "dogfood/v0.10-release-hardening/execution/WI-REL-GOVERNANCE/traceability-graph-snapshot.json";
...
const jobs = ["WI-REL-WORK-EXECUTION-RUNTIME", "WI-REL-GOVERNANCE"];
const summary = {
  apiVersion: API,
...
writeJson("traceability-graph-snapshot.json", final.snapshot);
writeJson("traceability-summary.json", summary);

...
const headPath =
  "dogfood/v0.10-release-hardening/execution/WI-REL-DESKTOP-DOGFOOD/traceability-graph-snapshot.json";
...
const jobs = ["WI-REL-DESKTOP-DOGFOOD"];
const summary = {
  apiVersion: API,
...
writeJson("desktop-dogfood-traceability-graph-snapshot.json", final.snapshot);
writeJson("desktop-dogfood-traceability-summary.json", summary);

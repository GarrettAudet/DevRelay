...
const headPath =
  "dogfood/v0.10-release-hardening/execution/WI-REL-WINDOWS-VERIFY/traceability-graph-snapshot.json";
...
const jobs = ["WI-REL-WINDOWS-VERIFY"];
const summary = {
  apiVersion: API,
...
writeJson("windows-traceability-graph-snapshot.json", final.snapshot);
writeJson("windows-traceability-summary.json", summary);

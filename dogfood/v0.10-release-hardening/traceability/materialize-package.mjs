...
const headPath =
  "dogfood/v0.10-release-hardening/execution/WI-REL-PACKAGE/traceability-graph-snapshot.json";
...
writeJson("package-traceability-graph-snapshot.json", final.snapshot);
writeJson("package-traceability-summary.json", summary);

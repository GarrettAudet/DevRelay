...
const headPath =
  "dogfood/v0.10-release-hardening/execution/WI-REL-PROTECTED-MAIN/traceability-graph-snapshot.json";
...
const jobs = ["WI-REL-PROTECTED-MAIN"];
const summary = {
  apiVersion: API,
...
writeJson("protected-main-traceability-graph-snapshot.json", final.snapshot);
writeJson("protected-main-traceability-summary.json", summary);

...
const headPath =
  "dogfood/v0.10-release-hardening/execution/WI-REL-ACCEPTANCE/traceability-graph-snapshot.json";
...
writeJson("acceptance-traceability-graph-snapshot.json", final.snapshot);
writeJson("acceptance-traceability-summary.json", summary);

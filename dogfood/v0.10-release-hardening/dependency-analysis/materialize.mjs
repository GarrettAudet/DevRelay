...
const REPOSITORY_REVISION = "a38d2ffde71b5226721a45fedf203c62fc093739";
...
const contextSliceSetValue = {
  ...
  sliceSetId: "CTXS-REL-DOGFOOD-002",
  slices: [
    createContextSlice({
      id: "CTX-REL-REQUIREMENTS",
    ...
    createContextSlice({
      id: "CTX-REL-REPOSITORY-REVISION",
...
const execution = await runtime.execute({
  executionId: "WDA-REL-DOGFOOD-002",
  workBreakdown,
  projectOverview,
  contextSliceSet,
  policyBundle,
...
const gateReview = await exactJsonFile(
  "work-dependency-gate-review.json",
  {
    ...
    reviewId: "WDA-REL-GATE-REVIEW-002",
...
const gateCandidate = await exactJsonFile(
  "gate-candidate.json",
  {
    ...
    gateCandidateId: "WDA-REL-GATE-CANDIDATE-002",
    candidate: execution.candidateRef,
    workBreakdownBaseline: workBreakdown.ref,

...
const APPROVED = Object.freeze({
  gateCandidate: "sha256:54d418027d9fe9b9e13c2c07e717b929fe3834d704cfaf35c314a7ac30232b27",
  ...
  projectOverviewChangeSet: "sha256:b37e2ab9be97e2f9b87976bd921d7ec1fe1ddba5ac7b1cc3f2ec53c8cac7865e",
  projectOverviewMarkdown: "sha256:9d31d62c868e1092cd0a40c4bc0f0f3adfe38ba7ab019ef1563ec2aac01250c9",
  nativeSourceBundle: "sha256:8e952fc0bc303d58208f34dc3e3e55c258e2e89c89888ae1099713a69fb5b13a",
  terminalCheckpoint: "sha256:0d3ae7ccbdf528895430fe0590c1effdb671457413acc05a59741d2b09e339ca",
  executionProof: "sha256:43b28f947113a9749e20cb9a325abf56d9589323e81761f1629c59df731ec590",
  gateReview: "sha256:5f6e8442951f966fef356b2c8e37dad3fe42369237434ca610ea9e462825ca30",
});

const LINEAGE = Object.freeze({
  clarificationCheckpoint:
    "sha256:0e9871c629024af3e089e0df9adc3d5bdb8e74500fd97a242d4df6bfa3f3dfbe",
});
...
for (const source of nativeBundleDocument.value.sources) {
  const relativePath = source.path.replace("dogfood/v0.10-release-hardening/", "");
...
const approval = Object.freeze({
  ...
  approvalId: "requirements-gate-approval-v0.10-release-hardening-v1",
  authority: "project-owner",
  decision: "approve",
  source: { channel: "chat", statement: "Only github source, garrett.audet@gmail.com, use main as the protected default branch" },
...
const requirementsBaseline = Object.freeze({
  ...
  baselineId: "requirements-baseline-devrelay-v1-v0.10-release-hardening-001",
  version: "1.8.0",
...
const projectOverviewBaseline = Object.freeze({
  ...
  baselineId: "project-overview-baseline-devrelay-v1-v0.10-release-hardening-001",
  version: "1.8.0",
...
const pendingPromotion = Object.freeze({
  ...
  promotionId: "requirements-promotion-v0.10-release-hardening-v1",
  state: "prepared",
  previous: {
...
await writeFile(
  new URL("requirements-gate-v0.10-release-hardening-v1.md", project),
...
const promotionProof = Object.freeze({
  ...
  proofId: "requirements-promotion-v0.10-release-hardening-v1",
  status: "pass",

...
const completions = canonicalLoaded(
  completionsValue,
  "ICFS-REL-PROTECTED-MAIN-FRONTIER",
...
const protectedMainFiles = [
  "dogfood/v0.10-release-hardening/protected-main/branch-protection-request.json",
  "dogfood/v0.10-release-hardening/protected-main/materialize-settings-receipt.mjs",
  "dogfood/v0.10-release-hardening/protected-main/settings-receipt.json",
];
const jobs = [{
  workItemId: "WI-REL-PROTECTED-MAIN",
  attemptId: "ATT-REL-PROTECTED-MAIN-001",
  files: protectedMainFiles,
  evidence: {
    artifactId: "EV-REL-PROTECTED-MAIN-001",
    command: "GitHub settings readback; strict verify matrix; CodeQL; OpenSSF Scorecard; GitHub source-release dry run",
    tests: 8,
  },
  permissions: [
    { kind: "filesystem.write", scope: { values: ["dogfood/v0.10-release-hardening/protected-main/**"] } },
    { kind: "network.connect", scope: { values: ["github.com", "api.github.com"] } },
    { kind: "process.spawn", scope: { values: ["gh", "node"] } },
  ],
}];

const graphHeadPath =
  "dogfood/v0.10-release-hardening/traceability/github-traceability-graph-snapshot.json";
...
writeJson("protected-main-execution-summary.json", summary);

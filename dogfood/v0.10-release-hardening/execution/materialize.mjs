...
const jobs = [
  {
    ...
    files: runtimeFiles,
    evidence: {
      artifactId: "EV-REL-WORK-EXECUTION-RUNTIME-001",
      command:
        "node --test test/work-execution-runtime.test.mjs test/work-execution-traceability.test.mjs test/traceability-append-only.test.mjs",
      tests: 8,
    },
    permissions: [
      { kind: "filesystem.write", scope: { values: ["src/**", "test/**", "README.md", "RELEASE.md"] } },
  ...
  },
  {
    ...
    evidence: {
      artifactId: "EV-REL-GOVERNANCE-001",
      command: "node --test test/release-governance.test.mjs",
      tests: 1,
    },
    permissions: [
...
const graphHeadPath =
  "dogfood/v0.10-release-hardening/assignment/replay-v4/traceability-graph-snapshot.json";
...
for (const relativePath of [
  "dogfood/v0.10-release-hardening/assignment/replay-v4/approved-traceability-update.json",
  "dogfood/v0.10-release-hardening/assignment/replay-v4/candidate-traceability-update.json",
  "dogfood/architecture-discovery/work-breakdown/traceability-update.json",
  "dogfood/v0.10-release-hardening/dependency-analysis/replay-v4/traceability-update.json",

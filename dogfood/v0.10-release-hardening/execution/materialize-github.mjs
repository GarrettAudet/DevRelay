...
const completions = canonicalLoaded(
  completionsValue,
  "ICFS-REL-GITHUB-AUTOMATION-FRONTIER",
...
const githubFiles = [
  ".github/workflows/materialize-release-candidate.yml",
  ".github/workflows/dependency-review.yml",
  ".github/workflows/codeql.yml",
  ".github/workflows/scorecard.yml",
  ".github/workflows/release.yml",
  "release/action-pins.json",
  "test/release-automation.test.mjs",
];
const jobs = [{
  workItemId: "WI-REL-GITHUB-AUTOMATION",
  attemptId: "ATT-REL-GITHUB-AUTOMATION-001",
  files: githubFiles,
  evidence: {
    artifactId: "EV-REL-GITHUB-AUTOMATION-001",
    command: "node --test test/release-automation.test.mjs test/release-governance.test.mjs; npm run release:check; GitHub workflow validation",
    tests: 3,
  },
  permissions: [
    { kind: "filesystem.write", scope: { values: [".github/workflows/**", "release/**", "test/release-automation.test.mjs"] } },
...
const graphHeadPath =
  "dogfood/v0.10-release-hardening/traceability/windows-traceability-graph-snapshot.json";
...
writeJson("github-execution-summary.json", summary);

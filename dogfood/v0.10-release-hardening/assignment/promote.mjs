...
const priorGraph = read("../dependency-analysis/replay-v4/traceability-graph-snapshot.json");
const priorProof = read(
  "../dependency-analysis/replay-v4/work-dependency-gate-promotion-proof.json",
);
...
const historicalUpdateSourcePaths = [
  ...
  "../dependency-analysis/replay-v4/traceability-update.json",
];
...
const candidate = await merge({
  invocation: {
    invocationId: "SA-REL-DOGFOOD-003",
    module: {
...
const approved = await merge({
  invocation: {
    invocationId: "SA-REL-GATE-DOGFOOD-003",
    module: {

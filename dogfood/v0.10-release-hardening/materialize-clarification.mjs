...
import {
  ...
  projectContext,
  questions,
} from "./v0.10-release-hardening-clarification-data.mjs";
...
const invocation = Object.freeze({
  ...
  invocationId:
    "invocation-requirements-v0.10-release-hardening-openspec-clarify-v1",
      ...
      adapter: {
        async invoke(_adapterInvocation, _adapterContext, producer) {
          ...
          const clarificationRequest = {
            ...
            requestSetId: "clarification-request-v0.10-release-hardening-v1",
            baseInputs,
            questions,
          };
          ...
          continuation = {
            ...
            continuationId: "requirements-continuation-v0.10-release-hardening-v1",
            ...
            confirmedFacts: [
              "The accepted 0.9.0 source/library baseline is pinned to repository revision a38d2ffde71b5226721a45fedf203c62fc093739.",
              "Apache-2.0 with DCO and ChatGPT Desktop on Windows are already owner-approved boundaries.",
              "The packed 0.9.0 artifact omits two declared ArchitectureDiscovery exports and cannot support the public-preview claim unchanged.",
              "The existing OSS edits remain a non-authoritative implementation draft.",
              "Adapters cannot route, approve, mutate TraceabilityGraph, or choose release progression.",
              "No promotable V0.10 public OSS preview requirements change exists until every blocking question is answered.",
            ],
...
const executionProof = {
  ...
  proofId: "requirements-clarification-v0.10-release-hardening-v1",
  ...
  releaseHardeningImplementationAllowed: false,
};
await writeFile(
...
await Promise.all([
  ...
  writeFile(
    ...
    Buffer.from(
      "# V0.10 public OSS preview dogfood\n\n" +
        "Current state: RequirementsGathering is checkpointed at `needs_clarification`. The exact request, continuation, approved baseline inputs, and effect checkpoint form the resumable package. No V0.10 public OSS preview requirements change, architecture candidate, work breakdown, or implementation is authorized.\n",
    ),
  ),
]);

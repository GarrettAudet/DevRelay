...
import {
  ...
  projectContext,
  questions,
} from "./specialist-assignment-clarification-data.mjs";
...
const invocation = Object.freeze({
  ...
  invocationId: "invocation-requirements-specialist-assignment-openspec-clarify-v1",
  runId: "dogfood-specialist-assignment-v1",
      ...
      adapter: {
        async invoke(_invocation, _adapterContext, producer) {
          ...
          const clarificationRequest = {
            ...
            requestSetId: "clarification-request-specialist-assignment-v1",
            baseInputs,
            questions,
          };
          ...
          continuation = {
            ...
            continuationId: "requirements-continuation-specialist-assignment-v1",
            ...
            confirmedFacts: [
              ...
              "SpecialistAssignment is selected and WorkExecution is blocked until SpecialistAssignmentGate promotes a complete baseline.",
              ...
              "SpecialistAssignmentGate owns exact SpecialistAssignmentBaseline authority.",
              "No promotable SpecialistAssignment module requirements change exists until every blocking question is answered.",
            ],
...
const executionProof = {
  ...
  proofId: "requirements-clarification-specialist-assignment-v1",
...
await writeFile(
  ...
  Buffer.from(
    "# SpecialistAssignment dogfood\n\n" +
      "Current state: RequirementsGathering is checkpointed at `needs_clarification`. The exact request, continuation, approved baseline inputs, and effect checkpoint form the resumable package. No SpecialistAssignment requirements change, architecture candidate, assignment contract, or implementation is authorized.\n",
    "utf8",
  ),
);

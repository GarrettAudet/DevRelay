...
export async function promoteSpecialistAssignmentArchitecture(context) {
  const {
    root,
    dir,
    read,
  ...
  const ownerApprovalBytes = read(
    "dogfood/specialist-assignment/architecture-design/architecture-gate-owner-approval.json",
  );
  ...
  const gateReviewRef = fileRef(
    "architecture-gate-review-specialist-assignment-v1",
  ...
  const executionProofRef = fileRef(
    "architecture-dogfood-execution-proof-specialist-assignment-v1",
  ...
  const promotedBaseline = {
    ...
    baselineId: "architecture-baseline-devrelay-v1-specialist-assignment-001",
  ...
  const promotedProjectState = {
    ...
    stateId: "project-architecture-state-devrelay-specialist-assignment-approved-v1",
    state: "baselined",
  ...
  const promotionId = "architecture-promotion-specialist-assignment-v1";
  ...
  fs.writeFileSync(
    path.join(projectDir, "architecture-gate-owner-approval-specialist-assignment-v1.json"),
    ownerApprovalBytes,
  );

...
const contextSliceSetValue = {
  ...
  sliceSetId: "CTXS-SA-DOGFOOD-001",
  slices: [
    createContextSlice({
      id: "CTX-SA-REQUIREMENTS",
...
const execution = await runtime.execute({
  executionId: "WDA-SA-DOGFOOD-001",
  workBreakdown,
  projectOverview,
  contextSliceSet,
  policyBundle,
...
const gateReview = await exactJsonFile(
  "work-dependency-gate-review.json",
  {
    ...
    reviewId: "WDA-SA-GATE-REVIEW-001",
...
const gateCandidate = await exactJsonFile(
  "gate-candidate.json",
  {
    ...
    gateCandidateId: "WDA-SA-GATE-CANDIDATE-001",
    candidate: execution.candidateRef,
    workBreakdownBaseline: workBreakdown.ref,

# DevRelay WorkExecution: WI-DESKTOP-PLUGIN

Execute only the exact task contract at:

`dogfood/chatgpt-desktop-runtime/execution/task-contracts/WI-DESKTOP-PLUGIN.attempt-001.task.json`
...
Use the `plugin-creator` skill and follow its validation workflow for this task.

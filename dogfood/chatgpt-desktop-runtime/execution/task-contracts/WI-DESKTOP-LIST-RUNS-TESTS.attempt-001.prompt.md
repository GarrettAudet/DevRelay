# DevRelay WorkExecution: WI-DESKTOP-LIST-RUNS-TESTS

Execute only the exact task contract at:

`dogfood/chatgpt-desktop-runtime/execution/task-contracts/WI-DESKTOP-LIST-RUNS-TESTS.attempt-001.task.json`

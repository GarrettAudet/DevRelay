# DevRelay WorkExecution: WI-DESKTOP-LIST-RUNS-DOCS

Execute only the exact task contract at:

`dogfood/chatgpt-desktop-runtime/execution/task-contracts/WI-DESKTOP-LIST-RUNS-DOCS.attempt-001.task.json`

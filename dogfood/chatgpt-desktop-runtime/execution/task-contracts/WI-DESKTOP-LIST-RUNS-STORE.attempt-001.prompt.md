# DevRelay WorkExecution: WI-DESKTOP-LIST-RUNS-STORE

Execute only the exact task contract at:

`dogfood/chatgpt-desktop-runtime/execution/task-contracts/WI-DESKTOP-LIST-RUNS-STORE.attempt-001.task.json`

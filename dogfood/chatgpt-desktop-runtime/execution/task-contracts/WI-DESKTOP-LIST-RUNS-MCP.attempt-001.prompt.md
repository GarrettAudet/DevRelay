# DevRelay WorkExecution: WI-DESKTOP-LIST-RUNS-MCP

Execute only the exact task contract at:

`dogfood/chatgpt-desktop-runtime/execution/task-contracts/WI-DESKTOP-LIST-RUNS-MCP.attempt-001.task.json`

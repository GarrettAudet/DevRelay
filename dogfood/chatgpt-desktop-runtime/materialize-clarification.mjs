...
import {
  ...
  projectContext,
  questions,
} from "./desktop-runtime-clarification-data.mjs";
...
const invocation = Object.freeze({
  ...
  invocationId:
    "invocation-requirements-chatgpt-desktop-runtime-openspec-clarify-v1",
  runId: "dogfood-chatgpt-desktop-runtime-v1",
  ...
  config: {
    ...
    changeName: "chatgpt-desktop-runtime-v1",
      ...
      adapter: {
        async invoke(_adapterInvocation, _adapterContext, producer) {
          ...
          const clarificationRequest = {
            ...
            requestSetId: "clarification-request-chatgpt-desktop-runtime-v1",
            baseInputs,
            questions,
          };
          ...
          continuation = {
            ...
            continuationId: "requirements-continuation-chatgpt-desktop-runtime-v1",
            ...
            confirmedFacts: [
              "The supported V1 user surface is ChatGPT Desktop on Windows.",
              "DevRelay Core remains the workflow authority; Desktop, MCP, app-server tasks, models, and adapters are bounded hosts or capabilities.",
              "One distinct Codex task per runnable work item is required by the requested production workflow.",
              "Fixture conformance is not live interoperability and adapter maturity must remain explicit.",
              "No promotable Desktop runtime requirements change exists until every blocking question is answered.",
            ],
...
const executionProof = {
  ...
  proofId: "requirements-clarification-chatgpt-desktop-runtime-v1",
  ...
  desktopRuntimeImplementationAllowed: false,
};
await writeFile(
...
await Promise.all([
  ...
  writeFile(
    ...
    Buffer.from(
      "# ChatGPT Desktop runtime dogfood\n\n" +
        "Current state: RequirementsGathering is checkpointed at `needs_clarification`. The exact request, continuation, approved baseline inputs, and effect checkpoint form the resumable package. No Desktop runtime requirements change, architecture candidate, work breakdown, or implementation is authorized.\n",
    ),
  ),
]);

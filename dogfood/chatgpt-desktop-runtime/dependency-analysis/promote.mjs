...
const APPROVED = Object.freeze({
  candidate: "sha256:473b91b689b53aef9f4f49345651097335af47f97f73a84595225f58d8335782",
  gateReview: "sha256:368241352d1255212aa3fcd1873cdf742e34617dc7b1efe68256a1cee00b55bb",
  gateCandidate: "sha256:91b5f76e652ef7f422c3f47946f9222f5f77441e93c97164101a4396f464f747",
  checkpoint: "sha256:d3f76bc6d5fc4c57d3e4b44a8243a096b6987cccd7bcf86bdeaa1a0d90339046",
  checkpointRaw: "sha256:bc25756c609993334339893f35c38a8b6efa94c51deeddf1ae6882e0f0c358d4",
  repositorySnapshot: "sha256:c0dd3271f26a397d533ff30c6a50abe5a1debcc37af7e7ab206c9cf4daca1e0f",
  repositoryRevision: "6e65cc0c30e7ed7bb368c1e03aa10255adb18bf8",
  repositoryTree: "sha256:dc8136503d5f6033da5418621e99b1ae09a57cb1f00e5039566916add4952e4f",
});
...
const candidate = await loadedJson(
  "dogfood/chatgpt-desktop-runtime/dependency-analysis/work-dependency-candidate.json",
  {
  ...
  "WDC-0B03F765C0EA640A",
);
const gateReview = await loadedJson(
  "dogfood/chatgpt-desktop-runtime/dependency-analysis/work-dependency-gate-review.json",
  CONTRACTS.gateReview,
  "WDA-DESKTOP-GATE-REVIEW-001",
);
const gateCandidate = await loadedJson(
  "dogfood/chatgpt-desktop-runtime/dependency-analysis/gate-candidate.json",
  CONTRACTS.gateCandidate,
  "WDA-DESKTOP-GATE-CANDIDATE-001",
);
const checkpoint = await loadedJson(
  "dogfood/chatgpt-desktop-runtime/dependency-analysis/execution-checkpoint.json",
  CONTRACTS.executionCheckpoint,
  "WDA-DESKTOP-DOGFOOD-001-CHECKPOINT",
);
...
const approvalValue = {
  ...
  approvalId: "WDA-DESKTOP-GATE-OWNER-APPROVAL-001",
...
const baselineValue = {
  ...
  baselineId: "WDB-DESKTOP-DOGFOOD",
  version: "1.0.0",
...
const priorRecord = await loadedJson(
  "dogfood/chatgpt-desktop-runtime/work-breakdown/module-execution-record.json",
  CONTRACTS.executionRecord,
  "work-breakdown-decompose-chatgpt-desktop-runtime-v1",
);
const priorGraphUrl = new URL(
  "dogfood/chatgpt-desktop-runtime/work-breakdown/traceability-graph-snapshot.json",
  ROOT,
);
...
const historicalUpdatePaths = [
  ...
  "dogfood/chatgpt-desktop-runtime/work-breakdown/traceability-update.json",
];
...
const invocation = {
  ...
  invocationId: "work-dependency-gate-promote-chatgpt-desktop-runtime-v1",
  runId: "work-dependency-gate-run-chatgpt-desktop-runtime-v1",
  nodeId: "work-dependency-gate-node-chatgpt-desktop-runtime-v1",
  module,
  inputs: {},
  options: {},
};
...
const promotionProofValue = {
  ...
  proofId: "WDA-DESKTOP-GATE-PROMOTION-001",
  status: "promoted",
  approval: approval.ref,
  gateCandidate: gateCandidate.ref,

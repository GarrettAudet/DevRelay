...
const REPOSITORY_REVISION = "6e65cc0c30e7ed7bb368c1e03aa10255adb18bf8";
...
const workBreakdown = await loadedFile(
  "dogfood/chatgpt-desktop-runtime/work-breakdown/work-breakdown-baseline.json",
...
const contextSliceSetValue = {
  ...
  sliceSetId: "CTXS-DESKTOP-DOGFOOD-001",
  slices: [
    createContextSlice({
      id: "CTX-DESKTOP-REQUIREMENTS",
    ...
    createContextSlice({
      id: "CTX-DESKTOP-REPOSITORY-REVISION",
      ...
      sourceVersion: { kind: "content-digest", value: repository.ref.digest },
      selector: "/revision",
      coveredRefs,
    }),
  ],
...
const execution = await runtime.execute({
  executionId: "WDA-DESKTOP-DOGFOOD-001",
  workBreakdown,
  projectOverview,
  contextSliceSet,
  policyBundle,
...
const gateReview = await exactJsonFile(
  "work-dependency-gate-review.json",
  {
    ...
    reviewId: "WDA-DESKTOP-GATE-REVIEW-001",
...
const gateCandidate = await exactJsonFile(
  "gate-candidate.json",
  {
    ...
    gateCandidateId: "WDA-DESKTOP-GATE-CANDIDATE-001",
    candidate: execution.candidateRef,
    workBreakdownBaseline: workBreakdown.ref,

...
const integrationSummary = readJson(
  "dogfood/sim-001-simplification/integration-frontier-5/integration-summary.json",
);
...
const completionsValue = readJson(
  "dogfood/sim-001-simplification/frontier-6/integrated-completion-fact-set.json",
);
const completions = canonicalLoaded(
  completionsValue,
  "ICFS-SIM-001-FRONTIER-6",
...
const jobs = [
  {
    workItemId: "WI-SIM-WINDOWS-E2E-RELEASE",
    attemptId: "ATT-SIM-WINDOWS-E2E-RELEASE-001",
    files: ["dogfood/sim-001-simplification/windows-e2e/external-project/.gitignore","dogfood/sim-001-simplification/windows-e2e/external-project/README.md","dogfood/sim-001-simplification/windows-e2e/external-project/architecture/architecture.md","dogfood/sim-001-simplification/windows-e2e/external-project/lifecycle-run.mjs","dogfood/sim-001-simplification/windows-e2e/external-project/main.gd","dogfood/sim-001-simplification/windows-e2e/external-project/main.tscn","dogfood/sim-001-simplification/windows-e2e/external-project/package.json","dogfood/sim-001-simplification/windows-e2e/external-project/project.godot","dogfood/sim-001-simplification/windows-e2e/external-project/requirements/requirements.md","dogfood/sim-001-simplification/windows-e2e/external-project/test/greeting_card_test.gd","dogfood/sim-001-simplification/windows-e2e/external-project/evidence/01-RequirementsGathering.json","dogfood/sim-001-simplification/windows-e2e/external-project/evidence/02-RequirementsGate.json","dogfood/sim-001-simplification/windows-e2e/external-project/evidence/03-ArchitectureDiscovery.json","dogfood/sim-001-simplification/windows-e2e/external-project/evidence/04-ArchitectureDesign.json","dogfood/sim-001-simplification/windows-e2e/external-project/evidence/05-ArchitectureGate.json","dogfood/sim-001-simplification/windows-e2e/external-project/evidence/06-ContractGeneration.json","dogfood/sim-001-simplification/windows-e2e/external-project/evidence/07-ContractGate.json","dogfood/sim-001-simplification/windows-e2e/external-project/evidence/08-WorkBreakdown.json","dogfood/sim-001-simplification/windows-e2e/external-project/evidence/09-WorkBreakdownGate.json","dogfood/sim-001-simplification/windows-e2e/external-project/evidence/10-WorkDependencyAnalysis.json","dogfood/sim-001-simplification/windows-e2e/external-project/evidence/11-WorkDependencyGate.json","dogfood/sim-001-simplification/windows-e2e/external-project/evidence/12-SpecialistAssignment.json","dogfood/sim-001-simplification/windows-e2e/external-project/evidence/13-SpecialistAssignmentGate.json","dogfood/sim-001-simplification/windows-e2e/external-project/evidence/14-WorkExecution.json","dogfood/sim-001-simplification/windows-e2e/external-project/evidence/15-WorkItemVerification.json","dogfood/sim-001-simplification/windows-e2e/external-project/evidence/16-WorkItemVerificationGate.json","dogfood/sim-001-simplification/windows-e2e/external-project/evidence/17-ChangeIntegration.json","dogfood/sim-001-simplification/windows-e2e/external-project/evidence/18-TraceabilityGraph.json","dogfood/sim-001-simplification/windows-e2e/external-project/evidence/19-SystemVerification.json","dogfood/sim-001-simplification/windows-e2e/external-project/evidence/20-BusinessAcceptanceGate.json","dogfood/sim-001-simplification/windows-e2e/external-project/evidence/LifecycleRunReport.md","dogfood/sim-001-simplification/windows-e2e/external-project/evidence/business-acceptance.json","dogfood/sim-001-simplification/windows-e2e/external-project/evidence/implementation-seal.json","dogfood/sim-001-simplification/windows-e2e/external-project/evidence/lifecycle-run-snapshot.json","dogfood/sim-001-simplification/windows-e2e/external-project/evidence/run-ledger-checkpoint.json","dogfood/sim-001-simplification/windows-e2e/external-project/evidence/system-evidence.json","dogfood/sim-001-simplification/windows-e2e/external-project/evidence/trace-query.json","dogfood/sim-001-simplification/windows-e2e/external-project/evidence/traceability-graph.json","dogfood/sim-001-simplification/windows-e2e/evidence/evidence-seal.json","dogfood/sim-001-simplification/windows-e2e/evidence/greeting-card-history.bundle","dogfood/sim-001-simplification/windows-e2e/evidence/windows-desktop-dogfood-summary.json","scripts/release-tools.mjs","test/sim-windows-desktop-e2e.test.mjs"],
    command: "node --test test/sim-windows-desktop-e2e.test.mjs",
    tests: 3,
  },
];
const permissions = [
...
const graphHeadPath =
  "dogfood/sim-001-simplification/integration-frontier-5/WI-SIM-VERSION-DOCS/traceability-graph-snapshot.json";
...
const summary = {
  apiVersion: API,
  kind: "Sim001FrontierSixExecutionSummary",

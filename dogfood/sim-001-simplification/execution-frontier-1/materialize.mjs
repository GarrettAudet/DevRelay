...
const jobs = [
  {
    workItemId: "WI-SIM-HOST-STORAGE",
    attemptId: "ATT-SIM-HOST-STORAGE-001",
    files: ["src/local-host-storage.mjs", "test/local-host-storage.test.mjs"],
    command: "node --test test/local-host-storage.test.mjs",
    tests: 8,
  },
  {
    workItemId: "WI-SIM-PROFILES",
    attemptId: "ATT-SIM-PROFILES-001",
    files: ["src/workflow-profiles.mjs", "test/workflow-profiles.test.mjs"],
...
const graphHeadPath =
  "dogfood/sim-001-simplification/assignment/promotion/traceability-graph-snapshot.json";
...
const summary = {
  apiVersion: API,
  kind: "Sim001FrontierOneExecutionSummary",

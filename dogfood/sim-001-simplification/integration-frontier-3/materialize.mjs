...
const outRoot = resolve(root, "dogfood/sim-001-simplification/integration-frontier-3");
mkdirSync(outRoot, { recursive: true });
const API = "devrelay.dev/v1alpha1";
const targetRef = "refs/heads/codex/sim-001-integration";
const sourceRef = "refs/heads/codex/sim-001-source-candidate-frontier-3";
...
const graphSummary = json("dogfood/sim-001-simplification/execution-frontier-3/execution-summary.json");
let graphSnapshot = json("dogfood/sim-001-simplification/execution-frontier-3/WI-SIM-HOST-EXECUTION/traceability-graph-snapshot.json");
...
const summary = {
  apiVersion: API,
  kind: "Sim001ThirdFrontierIntegrationSummary",
  targetRef,
  baseCommit,

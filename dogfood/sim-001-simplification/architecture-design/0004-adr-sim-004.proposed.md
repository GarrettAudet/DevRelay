# Externalize full evidence as checksum-bound GitHub Release assets
...
- OPT-SIM-RELEASE-ASSETS
- OPT-SIM-ALL-EVIDENCE-IN-GIT

## Decision Outcome

Chosen option: "OPT-SIM-RELEASE-ASSETS", because it preserves the approved authority boundary. The selected boundary preserves Core-owned routing, closure, validation, checkpointing, traceability, and Gate authority while allowing bounded best-in-class capabilities to be swapped.

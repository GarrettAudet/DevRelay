...
export async function promoteSimplificationArchitecture(context) {
  ...
  const ownerApprovalBytes = read(
    "dogfood/sim-001-simplification/architecture-design/architecture-gate-owner-approval.json",
  );
  ...
  const gateReviewRef = fileRef(
    "architecture-gate-review-sim-001-simplification-v1",
  ...
  const executionProofRef = fileRef(
    "architecture-dogfood-execution-proof-sim-001-simplification-v1",
  ...
  const promotedBaseline = {
    ...
    baselineId: "architecture-baseline-devrelay-v1-sim-001-simplification-001",
  ...
  const promotedProjectState = {
    ...
    stateId: "project-architecture-state-devrelay-sim-001-simplification-approved-v1",
    state: "baselined",
  ...
  const promotionId = "architecture-promotion-sim-001-simplification-v1";

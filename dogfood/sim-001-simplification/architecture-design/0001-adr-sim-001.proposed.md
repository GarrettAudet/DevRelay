# Layer a thin facade over released Core operations
...
- OPT-SIM-THIN-FACADE
- OPT-SIM-REWRITE-CORE

## Decision Outcome

Chosen option: "OPT-SIM-THIN-FACADE", because it preserves the approved authority boundary. The selected boundary preserves Core-owned routing, closure, validation, checkpointing, traceability, and Gate authority while allowing bounded best-in-class capabilities to be swapped.

# Keep domain behavior in optional packs
...
- OPT-SIM-OPTIONAL-PACKS
- OPT-SIM-DOMAIN-IN-CORE

## Decision Outcome

Chosen option: "OPT-SIM-OPTIONAL-PACKS", because it preserves the approved authority boundary. The selected boundary preserves Core-owned routing, closure, validation, checkpointing, traceability, and Gate authority while allowing bounded best-in-class capabilities to be swapped.

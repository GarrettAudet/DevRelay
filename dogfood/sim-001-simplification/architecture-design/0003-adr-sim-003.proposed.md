# Prove API tiers through subpaths before physical package splitting
...
- OPT-SIM-SUBPATH-FIRST
- OPT-SIM-IMMEDIATE-MONOREPO-SPLIT

## Decision Outcome

Chosen option: "OPT-SIM-SUBPATH-FIRST", because it preserves the approved authority boundary. The selected boundary preserves Core-owned routing, closure, validation, checkpointing, traceability, and Gate authority while allowing bounded best-in-class capabilities to be swapped.

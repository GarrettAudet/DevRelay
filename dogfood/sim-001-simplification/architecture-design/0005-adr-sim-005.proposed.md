# Use SQLite plus content-addressed artifacts for the local host
...
- OPT-SIM-SQLITE-CAS
- OPT-SIM-IN-MEMORY-ONLY

## Decision Outcome

Chosen option: "OPT-SIM-SQLITE-CAS", because it preserves the approved authority boundary. The selected boundary preserves Core-owned routing, closure, validation, checkpointing, traceability, and Gate authority while allowing bounded best-in-class capabilities to be swapped.

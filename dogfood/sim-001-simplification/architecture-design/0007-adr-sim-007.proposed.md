# Make crash recovery a first-class reconciled protocol
...
- OPT-SIM-RECOVERY-JOURNAL
- OPT-SIM-BEST-EFFORT-RESTART

## Decision Outcome

Chosen option: "OPT-SIM-RECOVERY-JOURNAL", because it preserves the approved authority boundary. The selected boundary preserves Core-owned routing, closure, validation, checkpointing, traceability, and Gate authority while allowing bounded best-in-class capabilities to be swapped.

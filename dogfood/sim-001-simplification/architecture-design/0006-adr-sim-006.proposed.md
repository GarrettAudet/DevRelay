# Isolate work with Git worktrees and one capability-enforced Desktop executor
...
- OPT-SIM-WORKTREE-EXECUTOR
- OPT-SIM-SHARED-WORKSPACE

## Decision Outcome

Chosen option: "OPT-SIM-WORKTREE-EXECUTOR", because it preserves the approved authority boundary. The selected boundary preserves Core-owned routing, closure, validation, checkpointing, traceability, and Gate authority while allowing bounded best-in-class capabilities to be swapped.

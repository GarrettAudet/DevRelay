# Use preview labeling until exact independent human review
...
- OPT-SIM-PREVIEW-UNTIL-REVIEW
- OPT-SIM-STABLE-BY-SELF-ATTESTATION

## Decision Outcome

Chosen option: "OPT-SIM-PREVIEW-UNTIL-REVIEW", because it preserves the approved authority boundary. The selected boundary preserves Core-owned routing, closure, validation, checkpointing, traceability, and Gate authority while allowing bounded best-in-class capabilities to be swapped.

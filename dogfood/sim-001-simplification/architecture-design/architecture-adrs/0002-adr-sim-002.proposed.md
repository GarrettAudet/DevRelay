# Resolve immutable workflow profiles without Gate bypass
...
- OPT-SIM-EXPLICIT-PROFILES
- OPT-SIM-SEPARATE-WORKFLOWS

## Decision Outcome

Chosen option: "OPT-SIM-EXPLICIT-PROFILES", because it preserves the approved authority boundary. The selected boundary preserves Core-owned routing, closure, validation, checkpointing, traceability, and Gate authority while allowing bounded best-in-class capabilities to be swapped.

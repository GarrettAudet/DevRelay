...
const outputRoot = fileURLToPath(new URL("./frontier-3/", import.meta.url));
...
const firstFacts = [
  readJson("dogfood/sim-001-simplification/frontier-2/COMPLETION-WI-SIM-HOST-STORAGE-001.json"),
  readJson("dogfood/sim-001-simplification/frontier-2/COMPLETION-WI-SIM-PROFILES-001.json"),
];
const execution = readJson("dogfood/sim-001-simplification/execution-frontier-2/execution-summary.json");
const verification = readJson("dogfood/sim-001-simplification/verification-frontier-2/verification-summary.json");
const integrationRetry = readJson("dogfood/sim-001-simplification/integration-frontier-2-retry/integration-summary.json");
const integratedRefs = new Map([
  ["WI-SIM-EVIDENCE-ASSETS", readJson("dogfood/sim-001-simplification/integration-frontier-2/WI-SIM-EVIDENCE-ASSETS/integration-result.json").outputs["integrated-change-record"][0]],
  ["WI-SIM-FACADE", readJson("dogfood/sim-001-simplification/integration-frontier-2/WI-SIM-FACADE/integration-result.json").outputs["integrated-change-record"][0]],
  ["WI-SIM-HOST-ISOLATION", integrationRetry.results[0].integratedChange],
]);
...
const readyFrontier = deriveReadyFrontier({ baseline, completionFacts, frontierId: "FRONTIER-SIM-001-003" });

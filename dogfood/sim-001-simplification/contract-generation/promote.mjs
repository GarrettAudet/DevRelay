...
const DISPLACED_CONTEXT = new URL("history/pre-sim-001-contract-promotion/", WORK_BREAKDOWN_CONTEXT);
const APPROVED = Object.freeze({
  candidate: "sha256:3ef22bc3e36c902a0d3c80aa269acf1f99a1a51f33b49f620f65a1afb67f578d",
  gateReview: "sha256:67073f6d85b49e337459082c427c1e318bc51466c753dd0d9c1fea5d2bc45e12",
  gateCandidate: "sha256:6d638167804337ca1601bc06cf1125f8c8dbb89ac4a17ae99de70ff0a0bda97e",
  checkpoint: "sha256:fd2b9b9df303345c264f0885ab478ecbee00977d811a90a8a4fd85548522f7ea",
  traceabilityUpdate: "sha256:937739872bdcb68d9eef524142bae7b8300ab0ecbc390ed212afe3a4e2c15d0a",
  executionRecord: "sha256:752b6f34df6d8c3722f2048b1fc00a1691920d44533ac82a68b43d05232a603d",
});
...
const approvalValue = {
  ...
  approvalId: "CGA-SIM-001-CONTRACT-CHANGE-001",
...
const stateValue = {
  ...
  stateId: "PCS-DEVRELAY-CONTRACTS-SIM-001-BASELINED-001",
  state: "baselined",
  architectureBaseline: dogfood.architecture.ref,
  projectOverviewBaseline: dogfood.projectOverview.ref,
...
const upstreamGraph = createTraceabilityGraphService({
  graphId: "devrelay/sim-001-contract-generation-promotion",
  projectId: "devrelay",
  store: graphStore,
  contributors: [
...
const gateInvocation = {
  invocationId: "contract-gate-promotion-sim-001-v1",
...
const promotionValue = {
  ...
  promotionId: "CGP-SIM-001-CONTRACT-CHANGE-001",
  candidate: dogfood.candidateLoaded.ref,
...
await preserveAndReplaceCurrent(
  ...
  new URL("project/history/contracts/CB-DEVRELAY-010/contract-baseline.json", ROOT),
);
await preserveAndReplaceCurrent(
  disposition,
  new URL("project/contract-disposition.json", ROOT),
  new URL("project/history/contracts/CB-DEVRELAY-010/contract-disposition.json", ROOT),
);
await preserveAndReplaceCurrent(
  promotion,
  new URL("project/contract-gate-promotion.json", ROOT),
  new URL("project/history/contracts/CB-DEVRELAY-010/contract-gate-promotion.json", ROOT),
);
await preserveAndReplaceCurrent(
  state,
  new URL("project/project-contract-state.json", ROOT),
  new URL("project/history/contracts/CB-DEVRELAY-010/project-contract-state.pre-sim-001.json", ROOT),
);

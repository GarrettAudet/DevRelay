...
const REPOSITORY_REVISION = "3374e75e4342efde0e395855a85600ed6614b4a8";
...
const contextSliceSetValue = {
  ...
  sliceSetId: "CTXS-WDA-SIM-001-001",
  slices: [
    createContextSlice({
      id: "CTX-WDA-SIM-001-REQUIREMENTS",
    ...
    createContextSlice({
      id: "CTX-WDA-SIM-001-ARCHITECTURE",
    ...
    createContextSlice({
      id: "CTX-WDA-SIM-001-REPOSITORY-REVISION",
...
const gateReview = await exactJsonFile(
  "work-dependency-gate-review.json",
  {
    ...
    reviewId: "WDA-GATE-REVIEW-SIM-001-001",
...
const gateCandidate = await exactJsonFile(
  "gate-candidate.json",
  {
    ...
    gateCandidateId: "WDA-GATE-CANDIDATE-SIM-001-001",
    candidate: execution.candidateRef,
    workBreakdownBaseline: workBreakdown.ref,

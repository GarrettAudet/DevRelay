...
const APPROVED = Object.freeze({
  candidate: "sha256:05380fc428ec5cc565e086b1794c6d531e2e39ca153d4986477961de07a1a1ff",
  gateReview: "sha256:7510dbb47360d8dc69fcb7e86dea59c2bd214a503489f1ed501c31741c47904f",
  gateCandidate: "sha256:a4951eb8f6b8cfd402ca42b6b90d78abc9fc94df3d7f593b1e3dad87ba484037",
  checkpoint: "sha256:634afef5d7c8f1d735935cf803c59e1e312d3bb411d99eadf0994bef159f9530",
  checkpointRaw: "sha256:b09585c4c998b7a04afeed56dfe6c4e22db5400df40b33603a5a4770ed67ec11",
  repositorySnapshot: "sha256:d683f78299576e36b4c57bd1f40b883f17abee07698f0920bcca013be9de97ca",
  repositoryRevision: "3374e75e4342efde0e395855a85600ed6614b4a8",
  repositoryTree: "sha256:afe9c5e8f9b3da6f20abf8d303327b72b77c196a6904a5bd41432e00ee919171",
});
...
const candidate = await loadedJson(
  "dogfood/sim-001-simplification/dependency-analysis/work-dependency-candidate.json",
  {
  ...
  "WDC-478A00A0D60A982B",
);
const gateReview = await loadedJson(
  "dogfood/sim-001-simplification/dependency-analysis/work-dependency-gate-review.json",
  CONTRACTS.gateReview,
  "WDA-GATE-REVIEW-SIM-001-001",
);
const gateCandidate = await loadedJson(
  "dogfood/sim-001-simplification/dependency-analysis/gate-candidate.json",
  CONTRACTS.gateCandidate,
  "WDA-GATE-CANDIDATE-SIM-001-001",
);
const checkpoint = await loadedJson(
  "dogfood/sim-001-simplification/dependency-analysis/execution-checkpoint.json",
  CONTRACTS.executionCheckpoint,
  "WDA-SIM-001-001-CHECKPOINT",
);
...
const approvalValue = {
  ...
  approvalId: "WDA-GATE-OWNER-APPROVAL-SIM-001-001",
...
const priorRecord = await loadedJson(
  ...
  "work-breakdown-decompose-sim-001-v1",
);
...
const invocation = {
  ...
  invocationId: "work-dependency-gate-promote-sim-001-v1",
  runId: "work-dependency-gate-run-sim-001-v1",
  nodeId: "work-dependency-gate-node-sim-001-v1",
  module,
  inputs: {},
  options: {},
};
...
const promotionProofValue = {
  ...
  proofId: "WDA-GATE-PROMOTION-SIM-001-001",
  status: "promoted",
  approval: approval.ref,
  gateCandidate: gateCandidate.ref,
...
const baselineHistory = new URL("project/history/work-dependency/WDB-V011-MODULE-QUALITY-002/WDA-GATE-PROMOTION-V011-MODULE-QUALITY-002/", ROOT);

...
const integrationSummary = readJson(
  "dogfood/sim-001-simplification/integration-frontier-4/integration-summary.json",
);
...
const repository = canonicalLoaded(
  {
    ...
    includedPaths: ["docs/**", "dogfood/**", "package.json", "package-lock.json", "project/history/**", "src/**", "test/**"],
...
const completionsValue = readJson(
  "dogfood/sim-001-simplification/frontier-5/integrated-completion-fact-set.json",
);
const completions = canonicalLoaded(
  completionsValue,
  "ICFS-SIM-001-FRONTIER-5",
...
const jobs = [
  {
    workItemId: "WI-SIM-REGRESSION-GATES",
    attemptId: "ATT-SIM-REGRESSION-GATES-001",
    files: ["dogfood/v0.11-module-quality/contract-generation/materialize.mjs","dogfood/v0.11-module-quality/dependency-analysis/materialize.mjs","dogfood/v0.11-module-quality/work-breakdown/materialize.mjs","project/history/1.9.0/ProjectOverview.md","project/history/1.9.0/project-overview-baseline.json","project/history/1.9.0/requirements-baseline.json","project/history/architecture/architecture-baseline-devrelay-v1-v0.11-module-quality-002/architecture-baseline.json","project/history/architecture/architecture-baseline-devrelay-v1-v0.11-module-quality-002/architecture-promotion.commit.json","project/history/architecture/architecture-baseline-devrelay-v1-v0.11-module-quality-002/architecture-promotion.pending.json","project/history/architecture/architecture-baseline-devrelay-v1-v0.11-module-quality-002/project-architecture-state.json","project/history/contracts/CB-DEVRELAY-010/contract-baseline.json","project/history/contracts/CB-DEVRELAY-010/contract-disposition.json","project/history/contracts/CB-DEVRELAY-010/contract-gate-promotion.json","project/history/contracts/CB-DEVRELAY-010/project-contract-state.pre-sim-001.json","project/history/specialist-assignment/SAB-22406E70A72F9D66/specialist-assignment-baseline.json","project/history/specialist-assignment/SAB-22406E70A72F9D66/specialist-assignment-promotion.commit.json","project/history/work-breakdown/1.9.1/project-work-breakdown-state.json","project/history/work-breakdown/1.9.1/work-breakdown-baseline.json","project/history/work-breakdown/1.9.1/work-breakdown-promotion.commit.json","project/history/work-breakdown/1.9.1/work-breakdown-promotion.pending.json","project/history/work-dependency/WDB-V011-MODULE-QUALITY-002/WDA-GATE-PROMOTION-V011-MODULE-QUALITY-002/work-dependency-baseline.json","project/history/work-dependency/WDB-V011-MODULE-QUALITY-002/WDA-GATE-PROMOTION-V011-MODULE-QUALITY-002/work-dependency-promotion.commit.json","test/business-acceptance-release.test.mjs","test/package-export-verification.test.mjs","test/project-baseline.test.mjs","test/v0.11-module-quality-assignment-dogfood.test.mjs","test/v0.11-module-quality-dependency-analysis-dogfood.test.mjs","test/v0.11-module-quality-dogfood.test.mjs"],
    command: "npm.cmd run verify",
    tests: 975,
  },
  {
    workItemId: "WI-SIM-VERSION-DOCS",
    attemptId: "ATT-SIM-VERSION-DOCS-001",
    files: ["CHANGELOG.md","README.md","RELEASE.md","docs/business-acceptance.md","docs/releases/0.10.0-rc.2.md","docs/version-policy.md","package-lock.json","package.json","test/sim-version-docs.test.mjs"],
    command: "node --test test/sim-version-docs.test.mjs test/api-tiers.test.mjs test/operator-cli.test.mjs",
    tests: 13,
  },
];
const permissions = [
  { kind: "filesystem.write", scope: { values: ["docs/**", "dogfood/**", "package.json", "package-lock.json", "project/history/**", "src/**", "test/**"] } },
  { kind: "process.spawn", scope: { values: ["node"] } },
];

const graphHeadPath =
  "dogfood/sim-001-simplification/integration-frontier-4/WI-SIM-PACK-CONFORMANCE/traceability-graph-snapshot.json";
...
const summary = {
  apiVersion: API,
  kind: "Sim001FrontierFiveExecutionSummary",
...
for (const job of jobs) {
  ...
  const moduleInvocation = {
    ...
    invocationId: `WE-SIM-001-${item.id}`,
    module: {
      id: "work-execution",
      version: "0.1.0",

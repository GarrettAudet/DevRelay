...
const outRoot = resolve(root, "dogfood/sim-001-simplification/integration-frontier-2");
mkdirSync(outRoot, { recursive: true });
const API = "devrelay.dev/v1alpha1";
const targetRef = "refs/heads/codex/sim-001-integration";
const sourceRef = "refs/heads/codex/sim-001-source-candidate-frontier-2";
...
const graphSummary = json("dogfood/sim-001-simplification/execution-frontier-2/execution-summary.json");
let graphSnapshot = json("dogfood/sim-001-simplification/execution-frontier-2/WI-SIM-HOST-ISOLATION/traceability-graph-snapshot.json");
...
const summary = {
  apiVersion: API,
  kind: "Sim001SecondFrontierIntegrationSummary",
  targetRef,
  baseCommit,

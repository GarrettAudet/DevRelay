...
const firstFacts = [
  ...
  "WI-SIM-PROFILES",
].map((id) => readJson(`dogfood/sim-001-simplification/frontier-5/COMPLETION-${id}-001.json`))
const execution = readJson("dogfood/sim-001-simplification/execution-frontier-5/execution-summary.json");
const verification = readJson("dogfood/sim-001-simplification/verification-frontier-5/verification-summary.json");
const integration = readJson("dogfood/sim-001-simplification/integration-frontier-5/integration-summary.json");
...
const readyFrontier = deriveReadyFrontier({ baseline, completionFacts, frontierId: "FRONTIER-SIM-001-006" });

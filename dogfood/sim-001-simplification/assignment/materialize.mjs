...
async function write(name, value) {
  ...
  return {
    ...
    ref: {
      ...
      uri: `devrelay-repo:///dogfood/sim-001-simplification/assignment/${name}`,
    },
  };
}
...
const repositoryContext = await read("dogfood/sim-001-simplification/repository-snapshot.json");
...
function a2aProfile({ slug, name, description, capabilityIds, toolIds, grantIds }) {
  ...
  const snapshot = {
    source: {
      ...
      uri: `fixture://devrelay/a2a/sim-001/${slug}.json`,
    },
    agentCard: card,
    toolIds,
    grantIds,
...
const gateCandidate = {
  ...
  gateCandidateId: "SA-GATE-CANDIDATE-SIM-001-001",
...
const approval = {
  ...
  approvalId: "SA-GATE-APPROVAL-SIM-001-001",
  decision: "approve",
...
const approvalRef = {
  ...
  uri: "devrelay-repo:///dogfood/sim-001-simplification/assignment/specialist-assignment-gate-owner-approval.json",
};
...
const proof = {
  ...
  proofId: "SA-DOGFOOD-PROOF-SIM-001-001",
...
await write("a2a-agent-card-snapshot-set.json", {
  ...
  snapshotSetId: "A2A-SNAPSHOT-SET-SIM-001-001",

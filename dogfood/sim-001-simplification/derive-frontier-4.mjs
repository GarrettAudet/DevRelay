...
const outputRoot = fileURLToPath(new URL("./frontier-4/", import.meta.url));
...
const firstFacts = [
  readJson("dogfood/sim-001-simplification/frontier-3/COMPLETION-WI-SIM-EVIDENCE-ASSETS-001.json"),
  readJson("dogfood/sim-001-simplification/frontier-3/COMPLETION-WI-SIM-FACADE-001.json"),
  readJson("dogfood/sim-001-simplification/frontier-3/COMPLETION-WI-SIM-HOST-ISOLATION-001.json"),
  readJson("dogfood/sim-001-simplification/frontier-3/COMPLETION-WI-SIM-HOST-STORAGE-001.json"),
  readJson("dogfood/sim-001-simplification/frontier-3/COMPLETION-WI-SIM-PROFILES-001.json"),
]
const execution = readJson("dogfood/sim-001-simplification/execution-frontier-3/execution-summary.json");
const verification = readJson("dogfood/sim-001-simplification/verification-frontier-3/verification-summary.json");
const integrationRetry = readJson("dogfood/sim-001-simplification/integration-frontier-3-retry/integration-summary.json");
const integratedRefs = new Map([
  ["WI-SIM-HOST-EXECUTION", readJson("dogfood/sim-001-simplification/integration-frontier-3/WI-SIM-HOST-EXECUTION/integration-result.json").outputs["integrated-change-record"][0]],
  ["WI-SIM-API-COMPAT", integrationRetry.results[0].integratedChange],
]);
...
const readyFrontier = deriveReadyFrontier({ baseline, completionFacts, frontierId: "FRONTIER-SIM-001-004" });

...
const outputRoot = fileURLToPath(new URL("./frontier-5/", import.meta.url));
...
const firstFacts = [
  readJson("dogfood/sim-001-simplification/frontier-4/COMPLETION-WI-SIM-API-COMPAT-001.json"),
  readJson("dogfood/sim-001-simplification/frontier-4/COMPLETION-WI-SIM-EVIDENCE-ASSETS-001.json"),
  readJson("dogfood/sim-001-simplification/frontier-4/COMPLETION-WI-SIM-FACADE-001.json"),
  readJson("dogfood/sim-001-simplification/frontier-4/COMPLETION-WI-SIM-HOST-EXECUTION-001.json"),
  readJson("dogfood/sim-001-simplification/frontier-4/COMPLETION-WI-SIM-HOST-ISOLATION-001.json"),
  readJson("dogfood/sim-001-simplification/frontier-4/COMPLETION-WI-SIM-HOST-STORAGE-001.json"),
  readJson("dogfood/sim-001-simplification/frontier-4/COMPLETION-WI-SIM-PROFILES-001.json"),
]
const execution = readJson("dogfood/sim-001-simplification/execution-frontier-4/execution-summary.json");
const verification = readJson("dogfood/sim-001-simplification/verification-frontier-4/verification-summary.json");
const integration = readJson("dogfood/sim-001-simplification/integration-frontier-4/integration-summary.json");
...
const readyFrontier = deriveReadyFrontier({ baseline, completionFacts, frontierId: "FRONTIER-SIM-001-005" });

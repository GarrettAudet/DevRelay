...
const integrationSummary = readJson(
  "dogfood/sim-001-simplification/integration-frontier-3-retry/integration-summary.json",
);
...
const completionsValue = readJson(
  "dogfood/sim-001-simplification/frontier-4/integrated-completion-fact-set.json",
);
const completions = canonicalLoaded(
  completionsValue,
  "ICFS-SIM-001-FRONTIER-4",
...
const jobs = [
  {
    workItemId: "WI-SIM-CLI",
    attemptId: "ATT-SIM-CLI-001",
    files: ["src/operator-cli.mjs", "bin/devrelay.mjs", "src/index.mjs", "package.json", "test/operator-cli.test.mjs"],
    command: "node --test test/operator-cli.test.mjs",
    tests: 6,
  },
  {
    workItemId: "WI-SIM-PACK-CONFORMANCE",
    attemptId: "ATT-SIM-PACK-CONFORMANCE-001",
    files: ["src/pack-conformance.mjs", "packs/godot/manifest.json", "packs/godot/index.mjs", "packs/fixtures/web-service/manifest.json", "packs/fixtures/web-service/index.mjs", "src/index.mjs", "package.json", "test/pack-conformance.test.mjs", "test/v0.11-frontier-two.test.mjs", "test/v0.11-frontier-three.test.mjs"],
    command: "node --test test/pack-conformance.test.mjs test/v0.11-frontier-two.test.mjs test/v0.11-frontier-three.test.mjs",
    tests: 20,
  },
];
const permissions = [
...
const graphHeadPath =
  "dogfood/sim-001-simplification/integration-frontier-3-retry/WI-SIM-API-COMPAT/traceability-graph-snapshot.json";
...
const summary = {
  apiVersion: API,
  kind: "Sim001FrontierFourExecutionSummary",

...
const integrationSummary = readJson(
  "dogfood/sim-001-simplification/integration-frontier-2-retry/integration-summary.json",
);
...
const completionsValue = readJson(
  "dogfood/sim-001-simplification/frontier-3/integrated-completion-fact-set.json",
);
const completions = canonicalLoaded(
  completionsValue,
  "ICFS-SIM-001-FRONTIER-3",
...
const jobs = [
  {
    workItemId: "WI-SIM-API-COMPAT",
    attemptId: "ATT-SIM-API-COMPAT-001",
    files: [
      "src/api-tiers.mjs",
      "src/root.mjs",
      "src/compat-v1.mjs",
      "src/index.mjs",
      "package.json",
      "docs/migrations/compat-v1-to-facade.md",
      "test/api-tiers.test.mjs",
    ],
    command: "node --test test/api-tiers.test.mjs",
    tests: 5,
  },
  {
    workItemId: "WI-SIM-HOST-EXECUTION",
    attemptId: "ATT-SIM-HOST-EXECUTION-001",
    files: [
      "src/desktop-execution-coordinator.mjs",
      "test/desktop-execution-coordinator.test.mjs",
    ],
    command: "node --test test/desktop-execution-coordinator.test.mjs",
    tests: 6,
  },
];
const permissions = [
...
const graphHeadPath =
  "dogfood/sim-001-simplification/integration-frontier-2-retry/WI-SIM-HOST-ISOLATION/traceability-graph-snapshot.json";
...
const summary = {
  apiVersion: API,
  kind: "Sim001FrontierThreeExecutionSummary",

...
const contextSliceSetValue = {
  ...
  sliceSetId: "CTXS-WDA-DOGFOOD-001",
  slices: [
    createContextSlice({
    ...
    createContextSlice({
      id: "CTX-WDA-REPOSITORY-REVISION",
...
const gateCandidate = await exactJsonFile(
  "gate-candidate.json",
  {
    ...
    gateCandidateId: "WDA-GATE-CANDIDATE-001",
    candidate: execution.candidateRef,
    workBreakdownBaseline: workBreakdown.ref,

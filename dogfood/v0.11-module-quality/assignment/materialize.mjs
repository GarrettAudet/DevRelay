...
async function write(name, value) {
  ...
  return {
    ...
    ref: {
      ...
      uri: `devrelay-repo:///dogfood/v0.11-module-quality/assignment/${name}`,
    },
  };
}
...
const repositoryContext = await read("dogfood/v0.11-module-quality/repository-snapshot.json");
...
const capabilityCatalog = {
  ...
  catalogId: "CC-V011-MODULE-QUALITY-001",
  version: "1.9.0",
  capabilities,
};
...
function a2aProfile({ slug, name, description, capabilityIds, toolIds, grantIds }) {
  ...
  const snapshot = {
    source: {
      ...
      uri: `fixture://devrelay/a2a/v0.11/${slug}.json`,
    },
    agentCard: card,
    toolIds,
    grantIds,
...
const nativeProfile = {
  ...
  source: {
    type: "native-catalog",
    version: "1.9.0",
    digest: canonicalJsonDigest({ id: "PROFILE-DEVRELAY-INTEGRATION-OWNER", version: "1.9.0" }),
  },
  ...
  evidence: [{
    ...
    sourceDigest: canonicalJsonDigest({ id: "PROFILE-DEVRELAY-INTEGRATION-OWNER", version: "1.9.0" }),
  }],
};
const specialistCatalog = {
  apiVersion: "devrelay.dev/v1alpha1",
  kind: "SpecialistCatalog",
  catalogId: "SC-V011-MODULE-QUALITY-001",
  version: "1.9.0",
...
const assignmentPolicy = {
  ...
  policyId: "AP-V011-MODULE-QUALITY-001",
  version: "1.9.0",
  workItemRules: [{
...
const invocation = {
  executionId: "SA-V011-MODULE-QUALITY-002",
  workBreakdown,
  workDependency,
  capabilityCatalog,
  specialistCatalog,
...
const gateCandidate = {
  ...
  gateCandidateId: "SA-GATE-CANDIDATE-V011-MODULE-QUALITY-002",
...
const approval = {
  ...
  approvalId: "SA-GATE-APPROVAL-V011-MODULE-QUALITY-002",
  decision: "approve",
...
const approvalRef = {
  ...
  uri: "devrelay-repo:///dogfood/v0.11-module-quality/assignment/specialist-assignment-gate-owner-approval.json",
};
...
const proof = {
  ...
  proofId: "SA-DOGFOOD-PROOF-V011-MODULE-QUALITY-002",
...
await write("a2a-agent-card-snapshot-set.json", {
  ...
  snapshotSetId: "A2A-SNAPSHOT-SET-V011-MODULE-QUALITY-002",

...
const priorGraph = read(
  "../dependency-analysis/promotion-v2/traceability-graph-snapshot.json",
);
const priorProof = read(
  "../dependency-analysis/promotion-v2/work-dependency-gate-promotion-proof.json",
);
...
const historicalUpdateSourcePaths = [
  ...
  "../dependency-analysis/promotion-v2/traceability-update.json",
];
...
const draft = loaded(
  ...
  draftValue.draftId,
  "devrelay-repo:///dogfood/v0.11-module-quality/assignment/specialist-assignment-draft.json",
);
const candidate = await merge({
  invocation: {
    invocationId: "SA-V011-MODULE-QUALITY-002",
    module: {
...
const approved = await merge({
  invocation: {
    invocationId: "SA-GATE-V011-MODULE-QUALITY-002",
    module: {

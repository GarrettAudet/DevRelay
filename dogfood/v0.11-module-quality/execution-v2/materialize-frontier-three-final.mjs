...
const graphHeadPath = "dogfood/v0.11-module-quality/execution-v2/WI-MQ-GODOT-COMPATIBILITY/traceability-graph-snapshot.json";
...
const summary = {
  apiVersion: API,
  kind: "V011ModuleQualityGeneration2ThirdFrontierFinalExecutionSummary",

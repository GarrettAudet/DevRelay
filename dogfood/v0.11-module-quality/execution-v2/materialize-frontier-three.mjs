...
const jobs = [
  {
    ...
    attemptId: "ATT-MQ-DESKTOP-SKILLS-002",
    files: [
  ...
  },
  {
    ...
    attemptId: "ATT-MQ-GODOT-COMPATIBILITY-002",
    files: [
  ...
  },
  {
    ...
    attemptId: "ATT-MQ-LIFECYCLE-REPORT-002",
    files: [
      "src/index.mjs",
  ...
  ...job,
  evidence: {
    artifactId: "EV-" + job.workItemId + "-F3-G2",
...
const summary = {
  apiVersion: API,
  kind: "V011ModuleQualityGeneration2ThirdFrontierExecutionSummary",

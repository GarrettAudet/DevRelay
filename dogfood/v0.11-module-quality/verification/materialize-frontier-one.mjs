...
const executionRoot = resolve(root, "dogfood/v0.11-module-quality/execution");
const verificationRoot = resolve(root, "dogfood/v0.11-module-quality/verification");
...
for (const workItemId of workItemIds) {
  ...
  const executionDir = `dogfood/v0.11-module-quality/execution/${workItemId}`;
...
const summary = { apiVersion: "devrelay.dev/v1alpha1", kind: "V011ModuleQualityFirstFrontierVerificationSummary", results };

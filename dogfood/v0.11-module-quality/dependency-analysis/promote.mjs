...
const OUTPUT = new URL("./promotion-v2/", import.meta.url);
const APPROVED = Object.freeze({
  candidate: "sha256:4c4e6fd493e432acbd6ea44e73fcdc1aaec247612c7f63aea1e8f564626753c7",
  gateReview: "sha256:1c8589a4efec5f4fa772cb4a29ad12bbe45012226c7eb295ebea09d4a48d781c",
  gateCandidate: "sha256:d1c788b7b7eea1a224360a0a3aad5b8a3623654e02e1b58457ac477afa522970",
  checkpoint: "sha256:ddc24eaa5c5f2b5a81e6c3075f9db8fec046b68f6c42b59ded93b63285f7e0b7",
  checkpointRaw: "sha256:b15c463dfd6ec1b4aca23bf6e8e39e743adc4ef99b42e2b9e737f98fab6e898e",
  repositorySnapshot: "sha256:317c73888f9b33e7830859993418b91ce2984db8e4dfda92a78c4e58b52fe200",
  repositoryRevision: "a97f1f5e3de896d0858a117b6672c5891a095ea3",
  repositoryTree: "sha256:fed7ec135b89f2c3423313ed3034dc58a912b95b376babad568731a93bcbcad2",
});
...
const candidate = await loadedJson(
  "dogfood/v0.11-module-quality/dependency-analysis/work-dependency-candidate.json",
  {
  ...
  "WDC-DBF6E31A8E524CE5",
);
const gateReview = await loadedJson(
  "dogfood/v0.11-module-quality/dependency-analysis/work-dependency-gate-review.json",
  CONTRACTS.gateReview,
  "WDA-GATE-REVIEW-V011-MODULE-QUALITY-002",
);
const gateCandidate = await loadedJson(
  "dogfood/v0.11-module-quality/dependency-analysis/gate-candidate.json",
  CONTRACTS.gateCandidate,
  "WDA-GATE-CANDIDATE-V011-MODULE-QUALITY-002",
);
const checkpoint = await loadedJson(
  "dogfood/v0.11-module-quality/dependency-analysis/execution-checkpoint.json",
  CONTRACTS.executionCheckpoint,
  "WDA-V011-MODULE-QUALITY-002-CHECKPOINT",
);
...
const approvalValue = {
  ...
  approvalId: "WDA-GATE-OWNER-APPROVAL-V011-MODULE-QUALITY-002",
...
const baselineValue = {
  ...
  baselineId: "WDB-V011-MODULE-QUALITY-002",
  version: "1.9.1",
...
const priorRecord = await loadedJson(
  ...
  "work-breakdown-decompose-v0.11-module-quality-v2",
);
...
const invocation = {
  ...
  invocationId: "work-dependency-gate-promote-v0.11-module-quality-v2",
  runId: "work-dependency-gate-run-v0.11-module-quality-v2",
  nodeId: "work-dependency-gate-node-v0.11-module-quality-v2",
  module,
  inputs: {},
  options: {},
};
...
const promotionProofValue = {
  ...
  proofId: "WDA-GATE-PROMOTION-V011-MODULE-QUALITY-002",
  status: "promoted",
  approval: approval.ref,
  gateCandidate: gateCandidate.ref,
...
const baselineHistory = new URL("project/history/work-dependency/WDB-V011-MODULE-QUALITY-001/WDA-GATE-PROMOTION-V011-MODULE-QUALITY-001/", ROOT);

...
const REPOSITORY_REVISION = "a97f1f5e3de896d0858a117b6672c5891a095ea3";
...
const contextSliceSetValue = {
  ...
  sliceSetId: "CTXS-WDA-V011-MODULE-QUALITY-002",
  slices: [
    createContextSlice({
      id: "CTX-WDA-V011-REQUIREMENTS",
    ...
    createContextSlice({
      id: "CTX-WDA-V011-REPOSITORY-REVISION",
...
const execution = await runtime.execute({
  executionId: "WDA-V011-MODULE-QUALITY-002",
  workBreakdown,
  projectOverview,
  contextSliceSet,
  policyBundle,
...
const gateReview = await exactJsonFile(
  "work-dependency-gate-review.json",
  {
    ...
    reviewId: "WDA-GATE-REVIEW-V011-MODULE-QUALITY-002",
...
const gateCandidate = await exactJsonFile(
  "gate-candidate.json",
  {
    ...
    gateCandidateId: "WDA-GATE-CANDIDATE-V011-MODULE-QUALITY-002",
    candidate: execution.candidateRef,
    workBreakdownBaseline: workBreakdown.ref,
...
await exactJsonFile(
  ...
  "application/json",
  "WDA-RUNTIME-PROOF-V011-MODULE-QUALITY-002",
);

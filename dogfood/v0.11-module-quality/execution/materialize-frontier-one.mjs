...
const projectOverview = canonicalLoaded(
  ...
  "project-overview-baseline-devrelay-v1-v0.11-module-quality-001",
...
const graphHeadPath =
  "dogfood/v0.11-module-quality/assignment/promotion/traceability-graph-snapshot.json";
...
for (const relativePath of [
  ...
  "dogfood/v0.11-module-quality/dependency-analysis/promotion/traceability-update.json",
  "dogfood/v0.11-module-quality/assignment/promotion/candidate-traceability-update.json",
  "dogfood/v0.11-module-quality/assignment/promotion/approved-traceability-update.json",
]) {
...
const summary = {
  apiVersion: API,
  kind: "V011ModuleQualityFirstFrontierExecutionSummary",
...
for (const job of jobs) {
  ...
  const invocationId = `WE-V011-${item.id}-001`;

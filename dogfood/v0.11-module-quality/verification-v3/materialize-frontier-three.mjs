...
const executionRoot = resolve(root, "dogfood/v0.11-module-quality/execution-v3");
const verificationRoot = resolve(root, "dogfood/v0.11-module-quality/verification-v3");
...
for (const workItemId of workItemIds) {
  ...
  const executionDir = `dogfood/v0.11-module-quality/execution-v3/${workItemId}`;
...
const summary = { apiVersion: "devrelay.dev/v1alpha1", kind: "V011ModuleQualityGeneration3ThirdFrontierVerificationSummary", results };

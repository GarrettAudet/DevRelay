...
const parentEvidence = path.join(devrelayRoot, "dogfood/v0.11-module-quality/windows-e2e/evidence");
...
const runId = "windows-godot-greeting-v011";
...
const contentPolicyBody = { apiVersion: API, kind: "LifecycleRunContentPolicy", policyId: "POLICY-GREETING-V011", version: "1.0.0", rules: [
...
const summary = { apiVersion: API, kind: "WindowsGodotDogfoodSummary", ...summaryBody, summaryDigest: api.canonicalJsonDigest(summaryBody) };
writeJson(parentEvidence, "windows-godot-dogfood-summary.json", summary);

...
const commonPermissions = [
  { kind: "filesystem.write", scope: { values: ["dogfood/**", "scripts/**", "src/**", "test/**"] } },
...
const graphHeadPath = "dogfood/v0.11-module-quality/execution-v3/WI-MQ-GODOT-COMPATIBILITY/traceability-graph-snapshot.json";
...
const summary = {
  apiVersion: API,
  kind: "V011ModuleQualityGeneration3ThirdFrontierFinalExecutionSummary",
...
writeJson("execution-summary-frontier-three-final.json", summary);

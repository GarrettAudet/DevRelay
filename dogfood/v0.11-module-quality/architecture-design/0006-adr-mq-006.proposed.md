# Expose compact read-only traceability queries
...
- OPT-MQ-READONLY-COMPACT-QUERY
- OPT-MQ-MUTABLE-FULL-GRAPH

## Decision Outcome

Chosen option: "OPT-MQ-READONLY-COMPACT-QUERY", because it preserves the approved authority boundary. The selected boundary preserves Core-owned routing, closure, validation, checkpointing, traceability, and Gate authority while allowing bounded best-in-class capabilities to be swapped.

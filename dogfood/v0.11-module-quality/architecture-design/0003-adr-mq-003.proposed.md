# Make provider acquisition a host-owned approved boundary
...
- OPT-MQ-HOST-PROVIDER-MANAGER
- OPT-MQ-ADAPTER-DOWNLOADS

## Decision Outcome

Chosen option: "OPT-MQ-HOST-PROVIDER-MANAGER", because it preserves the approved authority boundary. The selected boundary preserves Core-owned routing, closure, validation, checkpointing, traceability, and Gate authority while allowing bounded best-in-class capabilities to be swapped.

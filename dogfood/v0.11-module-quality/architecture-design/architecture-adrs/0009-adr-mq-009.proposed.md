# Keep upstream tools as bounded replaceable providers
...
- OPT-MQ-BOUNDED-UPSTREAM
- OPT-MQ-UPSTREAM-OWNS-LIFECYCLE

## Decision Outcome

Chosen option: "OPT-MQ-BOUNDED-UPSTREAM", because it preserves the approved authority boundary. The selected boundary preserves Core-owned routing, closure, validation, checkpointing, traceability, and Gate authority while allowing bounded best-in-class capabilities to be swapped.

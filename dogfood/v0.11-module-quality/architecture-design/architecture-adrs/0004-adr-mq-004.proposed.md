# Record canonical local execution receipts and metrics
...
- OPT-MQ-CORE-RECEIPTS
- OPT-MQ-ADAPTER-SUMMARIES

## Decision Outcome

Chosen option: "OPT-MQ-CORE-RECEIPTS", because it preserves the approved authority boundary. The selected boundary preserves Core-owned routing, closure, validation, checkpointing, traceability, and Gate authority while allowing bounded best-in-class capabilities to be swapped.

# Ship Godot as an optional engineering pack
...
- OPT-MQ-OPTIONAL-GODOT-PACK
- OPT-MQ-GODOT-IN-CORE

## Decision Outcome

Chosen option: "OPT-MQ-OPTIONAL-GODOT-PACK", because it preserves the approved authority boundary. The selected boundary preserves Core-owned routing, closure, validation, checkpointing, traceability, and Gate authority while allowing bounded best-in-class capabilities to be swapped.

# Keep one coherent V0.11 architecture change with phased downstream work
...
- OPT-MQ-COHERENT-CHANGE
- OPT-MQ-INDEPENDENT-UNBOUND-DESIGNS

## Decision Outcome

Chosen option: "OPT-MQ-COHERENT-CHANGE", because it preserves the approved authority boundary. The selected boundary preserves Core-owned routing, closure, validation, checkpointing, traceability, and Gate authority while allowing bounded best-in-class capabilities to be swapped.

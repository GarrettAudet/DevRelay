...
const sourceRef = "refs/heads/codex/v0.11-source-candidate-v2-frontier3";
...
const graphSummary = json("dogfood/v0.11-module-quality/execution-v2/execution-summary-frontier-three-final.json");
let graphSnapshot = json("dogfood/v0.11-module-quality/execution-v2/WI-MQ-LIFECYCLE-REPORT/traceability-graph-snapshot.json");
...
const summary = {
  apiVersion: API,
  kind: "V011ModuleQualityGeneration2ThirdFrontierIntegrationSummary",
  targetRef,
  baseCommit,

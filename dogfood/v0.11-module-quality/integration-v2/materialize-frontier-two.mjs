...
const sourceRef = "refs/heads/codex/v0.11-source-candidate-v2-frontier2";
const ids = Object.freeze([
  "WI-MQ-EVIDENCE-SEAL",
  "WI-MQ-GDUNIT4",
  "WI-MQ-GODOT-MCP",
  "WI-MQ-LIVE-ARCH-PROVIDERS",
  "WI-MQ-LIVE-SPEC-PROVIDERS",
  "WI-MQ-LOCAL-METRICS",
  "WI-MQ-REQUIREMENTS-STRATEGIES",
]);
...
const graphSummary = json("dogfood/v0.11-module-quality/execution-v2/execution-summary-frontier-two.json");
let graphSnapshot = json("dogfood/v0.11-module-quality/execution-v2/WI-MQ-REQUIREMENTS-STRATEGIES/traceability-graph-snapshot.json");
...
const summary = {
  apiVersion: API,
  kind: "V011ModuleQualityGeneration2SecondFrontierIntegrationSummary",
  targetRef,
  baseCommit,
...
writeFileSync(resolve(outRoot, "integration-summary-frontier-two.json"), `${api.canonicalJson(summary)}\n`, "utf8");

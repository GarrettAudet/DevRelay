...
const sourceRef = "refs/heads/codex/v0.11-source-candidate-v2";
const ids = Object.freeze([
  "WI-MQ-ADAPTIVE-INTERVIEW",
  "WI-MQ-EXECUTION-RECEIPTS",
  "WI-MQ-GDSCRIPT-DISCOVERY",
  "WI-MQ-PROVIDER-TOOLCHAIN",
  "WI-MQ-TRACE-QUERY",
]);
...
try {
  ...
  for (const workItemId of ids) {
    ...
    git(sourceRepo, "commit", "-m", `V0.11 ${workItemId}`);
...
const graphSummary = json("dogfood/v0.11-module-quality/execution-v2/execution-summary.json");
let graphSnapshot = json("dogfood/v0.11-module-quality/execution-v2/WI-MQ-TRACE-QUERY/traceability-graph-snapshot.json");
...
const summary = {
  apiVersion: API,
  kind: "V011ModuleQualityGeneration2FirstFrontierIntegrationSummary",
  targetRef,
  baseCommit,

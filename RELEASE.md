...
`architecture-design@0.1.0` as one private source release, version `0.1.0`.
...
7. installs that tarball offline and imports the package root and both module
   manifests from a disposable consumer.

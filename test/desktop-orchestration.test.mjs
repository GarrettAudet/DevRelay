...
test("high-risk and cross-cutting changes require independent adversarial review", () => {
  const requirement = resolveDesktopReviewRequirement({ workItemId: "WI-A", risk: "high", tags: ["cross-cutting"] });
  ...
  assert.equal(evaluateDesktopMergeReadiness({ requirement, implementerTaskId: "TASK-A", testDisposition: "pass", reviewDisposition: "pass", adversarialReview: { reviewerTaskId: "TASK-REVIEW", disposition: "pass" } }).outcome, "merge-ready");

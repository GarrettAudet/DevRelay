...
test("WorkDependencyAnalysis clarification package replays without adapter reinvocation", async () => {
  const [
    ...
    readBytes("../../project/history/1.0.0/requirements-baseline.json"),
    readJson("../../project/history/1.0.0/project-overview-baseline.json"),
    readBytes("../../project/history/1.0.0/project-overview-baseline.json"),
    readBytes("../../project/history/1.0.0/ProjectOverview.md"),

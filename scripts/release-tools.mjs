...
function installAndImport(tarball, packageDocument, temporaryRoot, exportInventory) {
  ...
  const smokeProgram = [
    ...
    'const hoPlan = api.createDesktopOrchestrationPlan({ runId: "RUN-HO-INSTALLED", projectId: "devrelay", horizonDigest: rmDigest, startingRevision: "b".repeat(40), maxConcurrency: 1, workItems: [] });',
    'const hoRun = { kind: "LocalHostRunState", version: 0, state: { plan: hoPlan, workState: {}, blockers: [], recovery: "clean" } };',
